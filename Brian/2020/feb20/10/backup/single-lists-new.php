...
// var_dump($catobj );
    ...
    //   alert('Hello ' + this.name + '!')
      // `event` is the native DOM event
        ...
        var feature_name = event.currentTarget;
        feature_name2 = feature_name.getAttributeNode("value").value;
        console.log(feature_name2);
        console.log((vm._data[feature_name]).val);



        var zf_post_id = jQuery(this).closest('.zf-item-vote').attr("data-zf-post-id");
        ...
        jQuery.ajax({
            ...
            data: {post_id: zf_post_id, post_parent_id: zf_post_parent_id, vote_type: 'up', action: 'mes-lc-feature-rate'},
