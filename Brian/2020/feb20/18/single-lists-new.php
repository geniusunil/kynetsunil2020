...
<?php 
    $license_percentage = 30;
    $subscription_percentage = 40;
    $freemium_percentage = 20;
    $one_time_license_percentage = 10;
    $coupon_all_list = 30;
    ...
    <div class="viewport inview">
      ...
      $item_result .= '    <circle r="44" cx="88" cy="88" fill="transparent" stroke="blue" stroke-width="88" transform="rotate(-90) translate(-176)"stroke-dasharray="calc('.$license_percentage.' * 276.32 / 100) 276.32"/>';
   ...
   //    $item_result .= '<text class="detail-text" font-size="20" line-spacing="25" fill="green"><tspan x="80" y="123">'.$freemium_percentage.'%</tspan></text>';
      ...
      $item_result .= '<circle r="44" cx="88" cy="88" fill="transparent"stroke="yellow" stroke-width="88" stroke-dasharray="calc('.$one_time_license_percentage.'  * 276.32 / 100) 276.32" transform="rotate(-90) translate(-176)" /><text class="detail-text" font-size="20" line-spacing="25" fill="#5BD49C"><tspan x="80" y="123">'.$one_time_license_percentage.'%</tspan></text></g></g>';
