...
<?php
          ...
          <?php          
                        ...
                        $sorted_features_array = $this->sort_features($total_fearturess, $features_ids); // for both compared items
///////////////////////////////////sort features////////////////////////////////////// 
...
Looking at the top 3 features when it comes to [feature 1] [{item b} wins the vote/ that being said {item a} is still voted well above the industry average.] Look at [feature 2] both {item a} and {item b} scores below the industry. With regards to [feature 3] neither solution has been recorded on our system has provided this feature</p>
