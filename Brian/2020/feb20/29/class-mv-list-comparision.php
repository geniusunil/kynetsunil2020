        ...
        <div class="comparison-box">
            ...
            <div class ="dropdownsection" style="margin-top: 0.5em;">
                <p>
                    ...
                    <select class='dropdown-one' id="select_chart_1" style="border:1px solid black"> 
                        <option value="valueformoney" selected>Value For Money</option>
                    ...
                    and
                    <select class='dropdown-two' style="border:1px solid black">
                        <option value="valueformoney" style="display:none">Value For Money</option>
                        <option value="easeofuse" selected>Ease Of Use</option>
                        <option value="customersupport">Customer Support</option>
                        <option value="featuresfunctionality">Features And Functionality</option>
                    </select>
                </p>
			...
			$(document).ready(function()
			{
				$('#select_chart_1').change(function()
				{
					...
					if(first_option == "valueformoney" || first_option == "customersupport" && second_option == "customersupport" || second_option == "valueformoney")
					{
						$('#series_chart_div_2').removeClass("hide_chart");
					}
					if(first_option == "valueformoney" || first_option == "featuresfunctionality" && second_option == "featuresfunctionality" || second_option == "valueformoney")
					{
						$('#series_chart_div_3').removeClass("hide_chart");
					}
					if(first_option == "easeofuse" || first_option == "featuresfunctionality" && second_option == "featuresfunctionality" || second_option == "easeofuse")
					{
						$('#series_chart_div_4').removeClass("hide_chart");
					}
					if(first_option == "customersupport" || first_option == "featuresfunctionality" && second_option == "featuresfunctionality" || second_option == "customersupport")
					{
						$('#series_chart_div_5').removeClass("hide_chart");
					}
					if(first_option == "customersupport" || first_option == "easeofuse" && second_option == "easeofuse" || second_option == "customersupport")
					{
						$('#series_chart_div_6').removeClass("hide_chart");
					}
				/*
					var asd = $( "#select_chart_1 option:selected" ).val();
					$("#select_chart_2 > option").each(function() 
					{
						var this_option = $(this).val();
				...
				$('#select_chart_2').change(function()
				{
					...
					/*
					var asd = $( "#select_chart_2 option:selected" ).val();
					alert(asd);
					*/
				});
			});
...
///////////////////////////////////////////// --end-- ///////////////////////////////////////////////////////                     
                ...
                // $passToMaps[]= array('in',3868,7564);
                // $passToMaps[]= array('gb',0,7464);
