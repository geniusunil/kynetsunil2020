...
//  $functionality_feature_average = round($functionality_count/count($all_item_id),2);// feature functionality average
// //  echo  $functionality_feature_average;
// $valueformoney_count = array_sum($value_money);
// $valueformoney_feature_average = round($valueformoney_count/count($all_item_id),2);// valueformoney average    
// // echo  $valueformoney_feature_average;
// $customersupport_count = array_sum($customersupport);
// $customersupport_feature_average = round($customersupport_count/count($all_item_id),2);// customersupport  average    
...
$price_sum = array_sum($price_trim);
 ...
 $over_all_count = array_sum($over_all);
 $over_all_avg = $over_all_count/count($all_item_id);//overall average
//  print_r($over_all_avg ); 
// echo $price_avg; //price average
...
$details .= '<div class="row">
      ...
      $details .= ''.$img.'</div> 
                ...
                $functionality_feature_average_sr = ($functionality_feature_average*10);
                    ...
                    if($over_all_count > $over_all_avg){
                        $overlist = "Complete solution ";
                    }
                    if( empty($dis_customer) && empty($ease_dis) && empty($price_list) && empty($overlist) ){
                        echo "No particluar area";
                             ...
                             $details .='<strong>Best For: </strong>
                                <ul class="feature_list"><li><i class="fa fa-square"></i> '.$dis_customer.'  </li>
                                <li><i class="fa fa-square"></i> '.$price_list.'</li>
                                <li><i class="fa fa-square"></i> '.$ease_dis.' </li>
                                <li><i class="fa fa-square"></i> '.$overlist.' </li>';
        $details .='</div>
        </div>
    </div>
</div>';
