 ...
 /**********************************************alternative informatoion ************************************************************************** */
   ...
   $item_result .= '<tr><th>Country</th><th>Usage</th>';
    ...
    foreach($downloads1 as $key=>$values){
        ...
        $country_name .= '<tr><td>'.$key.'</td> <td>'.$values.'%</td></tr>'; // decending order country usage 
        ...
        <ol class="_2iCXM">
            <li class="_3gKl5 _1xzv1 _1c9N4">
                ...
                <div class="_2qYt4 njNac">
                    <div class="zHZ2m _2zkHr">40<span class="_2-B6C">%</span>
                    </div>
        ...
        <li style="left:50.727273%" class="_3gKl5">
            <div class="Ywjxq">
                ...
                <div class="_2qYt4 kRixw">
                    <div class="zHZ2m _38leh">50<span class="_2-B6C">%</span>
                    </div>
            ...
            <div class="Ywjxq">
                <div class="_1mOpY">
                    ...
                    <div class="_2qYt4 _1wHMh">
                        <div class="zHZ2m _2fML7">80<span class="_2-B6C">%</span>
                        </div>
...
/* -----------------------------------------------get_single_sidebar fxn close--------------------------------------------------------------*/
    ...
    foreach($all_item_id as $all_items){
        ...
        $features_ratings[]  = get_field( 'features_list_ratings', $all_items ); 
        // $all_item_findrscore[] = calculate_findrscore_individual($all_items);
    ...
    // $findr_sum = array_sum($all_item_findrscore);
    // //    echo "findrsum";
    // //     echo $findr_sum;

    // $findr_avg = $findr_sum/count($all_item_id);
    // // echo "findravg";
    // // echo $this->findr_avg;
    
    // $min_value = min($all_item_findrscore);

    // $max_value = max($all_item_findrscore);
    ...
    $price_sum = array_sum($price_trim);
    $price_avg= $price_sum/count($all_item_id); //price average

    echo "price_sum";
    print_r($price_sum);
    echo "price_avg".$price_avg;
    
    $over_high_score = max($over_all);//overall highest score
    $item_rat_score = get_field( 'features_list_ratings', $item_id ); 
    foreach( $item_rat_score as  $item_rat){
        $item_rat_1[] = $item_rat[total_score];
    
    }
    $item_at_sum = array_sum($item_rat_1); // average sum
    echo "item score".$item_rat_1;
    foreach($features_ratings as $feature_rat)
    {
    foreach($feature_rat as $feature){
    ...
    echo "customer support ".$customersupport_count;
    echo "customersupport feature averaget ".$customersupport_feature_average;
    ...
    $details .= '<div class="row">
      ...
      $details .= ''.$img.'</div> 
                ...
                $functionality_feature_average_sr = ($functionality_feature_average*10);
                     $details .='<div class="item-description price_feature ">
                                    <div class="col-sm-6 easeofuse"> Features & Functionality <br>
                                        <div class="progress"> 
                                            ...
                                            <span class="sr-only" style="left: '.$ease_average_sr .'%  ;"></span>
                                    ...
                                    <div class="col-sm-6 easeofuse"> Ease of use <br>
                                        <div class="progress"> 
                                            ...
                                            <span class="sr-only" style="left: '.$functionality_feature_average_sr.'%;"></span>
                        ...
                        $details .='<div class="col-sm-6 easeofuse">Value for money<br>
                                        <div class="progress"> 
                                            ...
                                            <span class="sr-only" style="left: '.$valueformoney_feature_average_sr.'%;"></span>
                                    ...
                                    <div class="col-sm-6  easeofuse">Customer Support <br>
                                        <div class="progress"> 
                                            ...
                                            <span class="sr-only" style="left: '.$customersupport_feature_average_sr.'%;"></span>
                    ...
                    if($customersupport_count > $customersupport_feature_average  ){
                        $dis_customer = "Customer Support";
                    }
                  

                    if($ease_count > $ease_average){
                        $ease_dis = "Ease of Use";
                    }
                
                    if($price_sum > $price_avg){
                        $price_list = "Low cost software ";
                    }
                    ...
                    if( empty($dis_customer) && empty($ease_dis) && empty($price_list) && empty($overlist) && empty($features_name) ){
                        echo "No particluar area";
                    ...
                    // print_r($features_ratings);
                             ...
                             {
                                $details .=' <ul class="feature_list"><li><i class="fa fa-square"></i> '.$dis_customer.'  </li>';
                             }
                               if(!empty($price_list)){
                                $details .=' <li><i class="fa fa-square"></i> '.$price_list.'</li>';
                               }
                           if(!empty($ease_dis)){
                           ...
                           if(!empty($ease_overlistdis)){
                             ...
                             $details .='   <li><i class="fa fa-square"></i> '.$features_name.' </li>';
                             }
        $details .='</div>
        </div>
    </div>
