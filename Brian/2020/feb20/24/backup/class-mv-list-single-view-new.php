...
/* -----------------------------------------------get_single_sidebar fxn close--------------------------------------------------------------*/
    ...
    $this_pricing_model;
        ...
        if( in_array('one_time_license ',$item_pricing_model))
            ...
            {
            $price_item = 'one_time_license';
           

            }
            elseif(in_array('subscription',$item_pricing_model))
            {
...
print_r($price_start);
                ...
                $all_price_avg = $price_sum/count($all_item_id);        // all items avg price in a sorted way     
    ...
    $details .= '<div class="row">
      ...
      $details .= ''.$img.'</div> 
                ...
                $functionality_feature_average_sr = ($functionality_feature_average*10);
                    ...
                    if($this_item_price < $all_price_avg )
                        {
