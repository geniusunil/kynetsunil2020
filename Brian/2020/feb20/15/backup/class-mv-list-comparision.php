...
//////////////////////////////////////// --Features Section-- //////////////////////////////////////
  ...
  $Each_feature = array();
    ...
    ?>
    <li class="comp_theme"><?php if (in_array($t, $Each_feature)) { ?> <i class="fa fa-check-square" style="font-size:20px;color:green"></i> <?php }else{ ?> <i class="fa fa-remove" style="font-size:20px;color:red"></i><?php } ?><span><?php echo $features_details['tittle'.$key]; $f_ = str_replace(" ","_",$t)."_$i";  ?> </span></li>
          <?php 
