...
/* -----------------------------------------------get_single_sidebar fxn close--------------------------------------------------------------*/
    ...
    foreach($all_item_id as $all_items){
        ...
        $all_features_ratings[]  = get_field( 'features_list_ratings', $all_items ); 
        // $all_item_findrscore[] = calculate_findrscore_individual($all_items);
        
    
    
    }
    // echo "easeofuseindustryarray";
    // print_r($easeofuse); 
    ...
    $item_feature_rating = get_field( 'features_list_ratings', $item_id ); 
    // echo "item rat score";
    // print_r($item_rat_score);

    foreach( $item_feature_rating as  $key =>$item_rat){
        $item_feature_indivisual_avg[$key] = $item_rat[average];
        
    
    }
    $item_feature_sort = arsort($item_feature_indivisual_avg);
    // echo "item feature <pre>";
    // print_r($item_feature_indivisual_avg);
    // echo "</pre>";
    ...
    $total_score_feature[$key] = $feature[average];
    ...
    $all_ind_feature_sort = arsort($total_score_feature);
    echo "all_ind_feature_sort";
   print_r($all_ind_feature_sort) ;
    $compare = array_intersect_assoc($item_feature_sort,$all_ind_feature_sort);
echo "compare";
    print_r($compare);

// if($item_feature_indivisual_avg[$key] ===  $total_score_feature[$key] ){

//     echo "true";
//     print_r($item_feature_indivisual_avg[$key]);
