...
/* -----------------------------------------------get_single_sidebar fxn close--------------------------------------------------------------*/
    ...
    // print_r($item_feature_individual_avg);
    // echo "</pre>";
   ...
   echo "item feature sort";
   print_r($item_feature_individual_avg);
    $compare = array_intersect_assoc($item_feature_individual_avg,$total_score_feature);
echo "compare";
    print_r($compare);
echo "</pre>";
