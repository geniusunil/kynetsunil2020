...
<?php
				...
				//$check_arr = $this->sorted_features_array);
								
				$arrToPass = array(array('label'=> "product A",'backgroundColor'=>'blue','data'=> array(65, 75, 70, 80, 60, 80, 77, 90, 45, 76, 90, 56)),
				array('label'=> "item 2",'backgroundColor'=>'blue','data'=> array(25, 73, 10, 70, 68, 82, 72, 90, 40, 76, 60, 16)));
				...
				<div>
					...
					<?php print_r($total_feartures); ?>
					<script>
					
						var marksCanvas = document.getElementById("marksChart");

						var marksData = {
							labels: ["Search & Navigation", "Product Pages", "Omnichannel & Fulfillment", "Non Branded Paid Search", "Display Advertising", "Email", "Facebook", "youtube", "Instagram and Stories", "M-Commererce & Omnichannel", "Mobile Search", "Mobile Apps"],
