...
function multiverse_name_scripts() {
    ...
    if( is_page() || is_single() )
    {
        ...
        file_put_contents("list_creator.txt","posttype $posttype",FILE_APPEND);

        if($posttype=='list_items'||$posttype=="lists"||($posttype=='page' && ($post_slug=='compare' || $post_slug=='alternative'))){
