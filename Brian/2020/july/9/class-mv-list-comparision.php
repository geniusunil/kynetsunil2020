...
class Mv_List_Comparision
{
    ...
    public function setup_variables($compareId)
    {
        ...
        if(count($this->compareditems) > 1){
            ...
            $this->best_in_industry = array();
            $this->best_in_industry [$post_id]= get_or_refresh_best_for($post_id,$this->industry_averages);
            $this->best_in_industry [$post_id2]= get_or_refresh_best_for($post_id2,$this->industry_averages);
            /* echo "industry averages";
            print_r($this->industry_averages);
            echo "best in industry";
    ...
    public function get_column_betterthan($post_id, $item, $post_id2)
    {
        ...
        /* echo "best in indusry";
        print_r($this->best_in_industry[$post_id]); */
        foreach($this->best_in_industry[$post_id] as $bf){
            $r2b[] = "Best for " . $bf;
        }
                    ...
                    <div class="column-head">
						...
						foreach ($basedthings as $it => $ittitle) 
						{
                           ...
                           /*  echo "inside $it memory used ";
							...
							{
                                $filters = decide_filters($post_id,$post_id2);
                             /*    echo "filters";
                                print_r($filters); */
                                ?>
                                <div class="row">
