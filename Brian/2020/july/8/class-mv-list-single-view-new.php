...
class Mv_List_Single_View_New
{
	...
	public function get_list_faq()
	{
        ...
        $onlyExecute = $this->featured_section_block();
		...
		{
           $customListArray = $_SESSION['gen_list'][$list_id][''];
           echo '<h1>coming</h1>';
           print_r($customListArray);
           /* echo "full";
           print_r($_SESSION['gen_list'][$list_id]); */
            ...
            $finalVotes_jbs = do_shortcode("[total_votes id=$topProductWithFeature]");
			...
			$faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
				...
				<div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
				<div itemprop='text'>
					Ans. The results are in and over a ".$finalVotes_jbs." as cast their votes and ".get_the_title($topProductWithFeature)." is the recommended choice.
				 </div>
				</div>
			</div>"; 
		}
	...
	public function featured_section_block()
	{
		...
		<div class="container-fluid featured">
			<div class="container2">
				...
				$all5features = array($bestPromoted, $this->$bestoverall, $bestcustomerservice, $bestbudgetoption, $this->$bestoverallfree);
				?>
				<div class="row">
					<?php
					$widthClass = "col-3";
	...
	*/
    ...
    public function set_list_vars($post_id){
