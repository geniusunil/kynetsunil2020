...
class Mv_Acf_Hooks 
{
	...
	function change_dir_thumbs( $dir ) 
	{
		$update_post_id = $_SESSION['update_post_id'];
		return array(
			'path'   => $dir['basedir'] . '/listcreator/attachments/thumbs//'.$update_post_id.'/thumbs',
			'url'    => $dir['baseurl'] . '/listcreator/attachments/thumbs//'.$update_post_id.'/thumbs',
