        ...
        if (!empty($lists) && is_array($lists)) {
            ...
            foreach ($listrankord as $listid => $rank) {
                if ($rank < 4) {
                    ...
                    $r2b[] = "Category leader in <a href='" . get_permalink($listid) . "'>" . get_the_title($listid) . "</a>".$seeMoreAppend;
                    $countLeaders++;
                } elseif ($rank < 11) {
                    if($countLeaders>=2){
                        $seeMoreAppend = "<br><a href='#ranking'>See full list</a>";
                    }
                    $r2b[] = "A contender in <a href='" . get_permalink($listid) . "'>" . get_the_title($listid) . "</a>".$seeMoreAppend;
                    $countLeaders++;
                }
                if($countLeaders>2){
                    break;
