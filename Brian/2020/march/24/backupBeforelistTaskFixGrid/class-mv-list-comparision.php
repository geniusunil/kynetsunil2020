...
class Mv_List_Comparision 
{
                    ...
                    <div class="column-head">
						...
						foreach ($basedthings as  $it => $ittitle)
						{
							...
							elseif($it == "features") 
							{
								...
								<div class="single-list-data zf-item-vote" data-zf-post-id="<?php echo '136923'?>">
									...
									if(! empty($attributes_of_charts))
									{
														...
														{ 
															...
															<li class="comp_theme">
																...
																<span>
																	...
																	$f_			= validate_var_name($f)."_$i";//str_replace(" ","_",$t)."_$i"; 
																	$postid12	= ($i==1)?$item1:$item2; ?> 
																</span>
															</li>
                                                            <?php 
                                                            echo "t is ".$t;
										...
										$list_items = get_field('add_to_list',$post_id2);
								...
								<div class="row">
									<div class="col-md-12">
										<img style="width:100%; height:450px;" src="https://area52.softwarefindr.com/wp-content/uploads/2020/03/integrates.png"/>	
									</div>
								</div>
								<div class="row">
							...
							elseif($it == "ranking")
							{
								...
								{
									$listrankord2 = array();
									foreach ($lists2 as $id) 
									{
										$status  = is_string( get_post_status( $id ) );
										if ($status && !empty($id)) 
										{
											$rank = get_item_rank($id, $post_id2);
								...
								foreach($listrankord as $firstKey => $single_listrankord)
								{
									foreach($listrankord2 as $secondKey => $single_listrankord2)
									{
										if($firstKey == $secondKey)
										{
											if($single_listrankord[$firstKey] > $single_listrankord2[$secondKey])
											{
    ...
    public function get_sections()
	{
        ...
        $maps = array(
            ...
            'video'=>'Video Review',
            'download'=>'Which Should You Choose',
	...
	//alternate items
    function get_alternate_items($post_id, $post_id2) 
	{
				...
				<div class="item-alternates-body">
					...
					<div class="row">
						...
						{  
							...
							$this->ranklist = $this->get_item_ranks($pid);
						...
						<div class="col-md-12 my-text-center">
							<h5 style="font-weight:600; cursor: pointer;" id="seemore_alternates">See More Alternatives</h5>
						</div>
					</div>
				</div>
			</div>
    ...
    public function get_column_faq($post_id,$item,$post_id2)
	{
        ...
        $faq .= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        ...
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                            Ans. We have analyzed ".get_data_points_compare($post_id, $post_id2)." data points to answer this question, in ".date("Y")." ".$winner." is better than ".$loser.".
		...
		$faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        ...
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                                Ans. The main difference beyond price and support, is ".$winner." has an overall higher FindrScore which looks at over ".get_data_points_compare($post_id, $post_id2)." data points powered by real user testing and overall satisfaction.
                             </div>
                        </div>
                    </div>
                    ";
		...
		$faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                    ...
                    <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                        ...
                        Ans. The main difference beyond price and support, is ".$winner." has an overall higher FindrScore 
                             which looks at over ".get_data_points_compare($post_id, $post_id2)." data points powered by real user testing and overall satisfaction
                         </div>
                    </div>
                </div>
                ";   
	...
	function get_column_pricefs($post_id, $post_id2)
	{
		$item_one = get_the_title($post_id);
		$item_two = get_the_title($post_id2);
	...
	function get_column_software_finder_radar($post_id, $post_id2)
	{
