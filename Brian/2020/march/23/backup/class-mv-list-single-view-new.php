    ...
    function show_list( $content ) {  
         if ( is_singular( 'lists' ) && ! has_shortcode( $content, 'show_list' )  ) { 
            ...
            if ( ! has_shortcode( $post->post_content, 'show_list' ) ) {
                ...
                $content .= '<div class="container-fluid list_overview_sec">'.$this->list_geo_map().' </div></div>';
             
                $content .= $this->get_list_html( get_the_ID() );
                // $content .= $this->item_content_value(get_the_ID());
               
                $content .=   '<div class="item-overview-content">'.$this->list_price_performance_chart( get_the_ID()).'</div>';
                $content .=  $this->list_avg_cat_fndrscore($post_id);
                $content .= '<div class="item-overview-content">'.$this->list_comparion_data_show($post_id).'</div>';
                $content .= '<div class="item-overview-content">'.$this->list_trust_guid_sec(get_the_ID()).'</div>';    
...
//funtion compare table in list page 
    function list_compare_table($post_id){
  ...
  <table class="table table-striped" style="box-shadow: 0 0 22px rgba(0,0,0,0.20);">
  <thead>
    <tr>
      <th scope="col">Features</th>
        <?php 
        $k =0;
          foreach($lists as $item_id)
                    { 
                        // echo "abc";
                        $item_title = get_the_title($item_id);
                        ?>
                        <th scope="col"><?php echo $item_title; ?></th>
...
/******************************************** faq-2 start ***********************************************/
        ...
        foreach($qalist as $faq_ls){
          ...
          $faq.= " <div  itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        ...
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                                Ans. $iem_name as a high rating when it comes to  $topfeature_name, scoring  $topfeature_avg with a category average of $top_ind_avg .
    ...
    function list_contnet($listId){
        ...
        $htm = '<div class="headr_Sec_div" style="width: 87%;margin: 0 auto;"><div class="container-fluid list_overview_sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-10 contenttext"><div id="list_main_contnet">'.$contentP .'</div><div class="list-read-more"><a href="javascript:;" class="readbutton">Read More >>></a></div>
                </div>
                    <div class="col-md-2">
                    </div>
...
//         var_dump($adddata) ;
    ...
    function list_decision_sec($post_id){
        $post_id = get_the_id();
        ...
        foreach($list_feature as $key=> $item_key_feature_rat){ 
            $all_feature_score[] = $item_key_feature_rat[average];
            $all_feature_name[] = get_the_title($key);
            // echo "all feature";
            // print_r( $all_feature_name);
         $i++;
         if ($i ==3)
        break;
          }
        ...
        ?>
            <div class="decision_sec" >
            <div class="container-fluid">
            <div class="row" >
            <div class="col-sm-12"><h1 align="center">HOW TO MAKE YOUR DECISION</h1></div>
            <div class="col-sm-4" >


            
            <h3 align="center">  1 </h3>   
            <h4 align="center"><strong> PRICE EXPECTATIONS </strong> </h4>                      
              <?php
            ...
            <h4 align="center"> <strong>FUNCTIONALITY</strong> </h4>    
            <span>  You should take some time to figure out what features are mission-critical to your project. Our users tend to look for a provider that offers <?php echo $all_feature_name[0];?> and <?php echo $all_feature_name[1]; ?>, as well as a <?php echo $all_feature_name[2]; ?>.
            </div>
            <div class="col-sm-4">
            <h3 align="center"> 3 </h3>  
            <?php $list_data_points = get_data_points_list_item($main_list_id); 
            
            // echo "findrscoree";
            // echo $list_data_points;
            ?>
            <h4 align="center"> <strong>FINDRSCORE </strong> </h4>   
...
<!--   webinar section   -->
<?php    $get_list_name =  get_field( 'list_content_title_singular', $main_list_id );
           $finalVotes111 = do_shortcode("[[year] id=$main_list_id]");
if( !empty($get_list_name) )
         {
             $list_title = $get_list_name;

         }
         else{
            $list_title = get_the_title( $main_list_id);

         } ?>
            <div class="container-fluid">
            <div class="row" >
            <div class="col-sm-12"> <h3 align="center">  What is the  <?php echo $list_title; ?> ? </h3> 
...
<!-- // echo  -->
<?php
        echo '<p align="center">Without further adieu, here are our picks for the item in 2019 according to '.$finalVotes.' users.</p>';
...
">
             ...
             <?php  $decisin_sec = $this->list_decision_sec($post_id); ?>
         <section id="filter">
         </section>
...
//                                                echo '</pre>';
            ...
            <?php echo  $this->list_compare_table();?>
...
// echo "awaard list";
        ...
        $ranked_result .= '<div id="ranking" class = "ranking_sec">';
        ...
        "><img src="https://area52.softwarefindr.com/wp-content/uploads/2020/02/leaf4a.png" class="award_leaf">'.$total_award.'  Awards<img src="https://area52.softwarefindr.com/wp-content/uploads/2020/02/leaf4b.png" class="award_leaf">';

        $ranked_result .= '</div>';//col-sm - 4 close
        $ranked_result .= '<div class = "col-sm-6"> ';
        $ranked_result .= $award_list ;
        // $ranked_result .= $award_position_text ;
    ...
    //   echo "post id ".$post_id;
        ...
        foreach($item_rating_feature as $f => $r){
            ...
            $key_feature_result .= '<h4>  '.$f.' <span> <i class="fa fa-question-circle qmark" style=" color:grey; margin-top: 2px;"></i></span> </h4>';
        ...
        $key_feature_result .= '},  
                   ...
                   if(input.length === 0){           
                    ...
                    var feature_name_validated = input[0].getAttribute("data-validated-obj");
                    //(jQuery(event.target).find(\'input\')[0]).getAttribute("data-validated-obj");
                    if(feature_name_validated === null){
   ...
   $coupn_count = count($all_list);
    ...
    $one_time_license_percentage = round($one_time_license_list/count($all_item_id)); 
        ...
        $subscription_percentage_title = "Subscription";   
            ...
            $pricing_result .= '<div id="circles" style="    position: relative; background:#2898f7;">
        ...
        function price_performance_chart($post_id){
            ...
            foreach($comared_data as $post_idss)
                ...
                $avg_price = array_sum($all_price_trim)/count($comared_data );
                // echo "avg price";
                // print_r($avg_price);
...
// echo $itemfs;
       ...
       $performance_chart_result.=' <div class ="graph_text" ><div class="textgraph" style="text-align: left;">';
        $performance_chart_result.=' $'.round($avg_price,2).'<br>  That is the average price for a solution in this field and '.$show_data.'';
        ...
        function list_price_performance_chart($post_id){
        ...
        <?php 
         ...
         return $performance_chart_result;
            ...
            //     { 
            //     $data[$index] = $arr[$i]; 
            //     $abc[]= combinationUtil($arr, $data, $i + 1, $end, $index + 1, $r); 
            //     file_put_contents("mvlistsvn.txt","comapreee : ".print_r($abc,true)."end of video_list_new\n",FILE_APPEND);
        ...
        function list_comparion_data_show($post_id){
            $post_id = get_the_id();
            $lists =  get_field( 'list_items', $post_id, false );
            $i=0;
            $list_comparion_data .= '<h1 style=" font-size: 1.75rem; font-family: ProximaNova !important;">           
              Compare '.get_the_title($post_id).' to Similar Solutions
              </h1>';
            ...
            foreach($lists as $post_idss)
                ...
                for( ; $abc+1 < count($listfour_id); $abc++){
                    ...
                    for(; $def <count($listfour_id); $def++ ){
                        ...
                        $list_comparion_data .= '<div class="comparison-box-list col-sm-5 " style="height: 125px !important; text-align:center;">
        ...
        function list_trust_guid_sec($post_id){
          ...
          Why You Should Trust Us
            ...
            In the last 12 months, we have a crunch [total data points] data points in our system which paints a unique picture of each product from where they stand in the market, users sentiment and so on. All that is not without the of over [x number of voters] user contribution rating and reviewing over [total items] products on our platform. That is the SoftwareFindr difference big data meets real user experiences
            ';
            $data .= '</div></div>';
        ...
        function list_avg_cat_fndrscore($post_id){
            $post_id = get_the_id();
            $lists =  get_field( 'list_items', $post_id, false ); 
            ...
            //-----------------Average findrscore in this category chart start--------------------------------
                $minfs_list =  $this->list_max_fs;
                $highest_fs = $this->list_min_fs;
                $all_fs_svg = $this->list_avg_fs;
                $item_result .='<div class="_30_3B" style="max-width: 75% !important;"> 
                <div class="_27_Cy">
...
<?php
    ...
    //     }
      ...
      $item_result .= '<style>
        .background_softwareFinderRadar{
            background-image: url("https://area52.softwarefindr.com/wp-content/uploads/2020/03/mouseover_chart_transparent.png");
        ...
        <div class="col-md-12">
            <script type="text/javascript">
                ...
                function drawSeriesChart_7() 
                {
                    ...
                    var options = {
                        title: \'\',
                        hAxis: {title: \'Research Frequency\', gridlines: {color: \'transparent\'}, textPosition: \'out\', ticks: [{v:0, f:\'Weak\'}, {v: rangeX.max, f:\'Strong\'}]},
            ...
            <div class="background_softwareFinderRadar" style="width:800px;">
                <div id="softwareFinderRadar" style="width: 800px; height: 600px;"></div>
            </div>
        </div></div>';


        $item_result .= '
<div>The SoftwareFindr Radar compares all solutions on our platform in your chosen category and tries to segment them to give you a visual representation of the market. All the solutions are compared two-dimensionally which takes into 
...
'.$fs_average.' which we\'ve used as a threshold to only show the top 10 solutions.
</div>
        ';
    ...
    console.log(svg1);
            ...
            $compObj = new Mv_List_Comparision();
                ...
                $item_result .= "</div>";
                    ...
                    $cheap_list_data = $checp_item_score_list;
                ...
                //    echo $cheap_list_data;
                   if ($indust_avg < $cheap_list_data)
                   {
                    ...
                    <a href="'.get_the_permalink( $post_id ).'alternative"> click on the alternative report.</a>
                   </p>';
    ...
    function videos_sec($postid){ 
        $post_id = get_the_id();
        $details .= '<div class = "item-videos item-sec-div" id="video">';
    ...
    if(!empty($video_list_new)){ 
            ...
            foreach($video_list_new as $new)
                ...
                //						print_r($splittedstring);
                    ...
                    $details .= '<div class="vid-item '.$active.'" data-url="https://youtube.com/embed/'.$video_list_new[$i].'"  onClick="document.getElementById(\'vid_frame1\').src=\'https://youtube.com/embed/'.$video_list_new[$i].'?autoplay=1&rel=0&showinfo=0&autohide=1\'">
...
?>
       <?php 
        ...
        $item_result .= '<div class = "item-videos item-sec-div" >';
    ...
    //						print_r($splittedstring);
                        ...
                        // $content = file_get_contents("http://youtube.com/get_video_info?video_id=".$video_list_new[$i]);	
                        $api = "AIzaSyCXRiwRiOYQBHbOFeinDzo6YsPFH1S_uhY"; // YouTube Developer API Key testdemo256@gmail.com

                        // $content = file_get_contents("https://www.googleapis.com/youtube/v3/videos?key=$api&part=snippet&id=".$video_list_new[$i]);	
                        $content = file_get_contents("youtubeapidata.txt");	
     ...
     foreach($lists as $post_idss)
         {   
            foreach($targetCountries as $key=>$tc){
                ...
                $downloads1[$tc] += ceil((float)get_field( 'downloads_in_'.$key, $post_idss));
      ...
      if($sum_value == 0){
          ...
          $item_result .= '<div id="list_map_data" style="width: 70%; height: 500px; float: left;"></div>';
          $item_result .= '<div class="country-box">';
          $item_result .= '<div class="box1">
          <table id="countries_list">';
          $item_result .= '<tr><th>Country</th><th>Usage</th>';
    ...
    function adaptation_of_geo_map($post_id){

        // $post_id = get_the_id();
        // echo $post_id;
        $item_result .= '<div class = "item-map item-sec-div mapp-sec">';
        $item_result .= '<h3>Adaptation by Geography </h3>';
...
/*     function get_number_of_reviews($rating_item){
        // echo "rating item";
        // print_r($rating_item);
        // echo "rating item ends";
        $index_start = strpos($rating_item,"rwp-rating-stars-count");
        // echo "index start is ";
        // echo $index_start;
        $index_end = strpos($rating_item," vote");
        // echo "index end is ";
        // echo $index_end;
        $sub = substr($rating_item,$index_start,$index_end-$index_start+4);
       /*  echo "sub is ";
        echo $sub;
        $int = (int) filter_var($sub, FILTER_SANITIZE_NUMBER_INT);
        echo "int is ";
        echo $int; */
    ...
    //        $btnhtml = '<a class="mes-lc-li-down aff-link head-links" href="'.$afflink.'" rel="nofollow" target="_blank">'.$btntext.'</a>';
        $revHeader = "<div id='review-fix-header'>
         ...
         $conlast = '<div id="overview">
                        ...
                        <div>
                          <span itemprop="description"> '.$contentP.'</span>
...
// $result_fs= array_merge_recursive($all_weak_fs_title, $all_highest_fs);
// echo "dresult_fs";
// print_r($$all_item_findrscore);

// $result_fs = array_merge_recursive($this->all_highest_fs_title,$this->all_highest_fs); 
// echo "recursoive list";
// print_r($result_fs);
...
// print_r($total_score_feature_ind_avg);
    ...
    if($nor > 10){
        $details .= '<img class="leaf1" src="https://area52.softwarefindr.com/wp-content/uploads/2020/02/leaf1.png"><div class="row11" style="
        height: fit-content;
    "> 
    ...
    </div><img src="https://area52.softwarefindr.com/wp-content/uploads/2020/02/leaf2.png" class="leaf1">';
    }
   
    $details .= '<a style="
    display: flex;
" href="#ranking"><img style="
    margin-left: 20px;
" class="leaf1" src="https://area52.softwarefindr.com/wp-content/uploads/2020/02/leaf3a.png"><div class="awars_sec"> 
    <div class="user-rat-sec"><span>'.$this->total_award.'</span>
        <div class="rat-section"> Awards</div>                      
    </div>
    </div><img class="leaf1" src="https://area52.softwarefindr.com/wp-content/uploads/2020/02/leaf3b.png">     
    ...
    function increment_visit_count($post_id){
