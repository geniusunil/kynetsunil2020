...
$(document).ready( function () {
  ...
  // $month = date("F");
  return "<div class='corona_heading'><span class='corona_label'>confirmed : </span><span class='value'>".$confirmed ."</span><span class='corona_label'> deaths : </span><span class='value'>".$deaths."</span><span class='corona_label'>recovered : </span><span class='value'>".$recovered."</span><span class='corona_label'> unresolved : </span><span class='value'>".$unresolved."</span></div>".$table;
}
