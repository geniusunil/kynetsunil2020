...
research frequency. The average FindrScore for products like [item] is 
[insert average findr score] which we\'ve used as a threshold to only show the 
top 10 solutions.
</div>
        </div>
  ...
  if(empty($alternateinfo)){
    ...
    //  echo $data_point;
        ...
        $item_result .= '<div class = "item-content-editor item-sec-div"> <b>Editors note </b> - This review has been created by looking at '.$data_point.' and the opinions of actual users of the software and the company representative. 
...
?>
    ...
    function adaptation_of_geo_map(){
        $item_result .= '<div class = "item-map item-sec-div">';
        $item_result .= '<h3>Adaptation by Geography </h3>';
      /************************************************************chart******************************************************************* */
