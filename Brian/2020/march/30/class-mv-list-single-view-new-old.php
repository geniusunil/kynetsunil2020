...
jQuery.ajax({
							...
							type:'POST',
							data: {"action": "infinite_scroll", "page_no": 1, "list_id": <?php echo $list_id; ?>},
							beforeSend: function() {
       ...
       /*  $temp_array=array();
        ...
        // $totalActVOtes = 0;
            ...
            if(isset($sorts) && $sorts =="free"){
                $postarr = $this_list['free'];
            }elseif(isset($sorts) && $sorts =="affordable_price"){
                $postarr = $this_list['affordable'];
            }elseif(isset($sorts) && $sorts =="User_friendly"){
                $postarr = $this_list['User_friendly'];
            }else{
                $postarr = $this_list['overall'];
            }
...
/* -----------------------------------------------get_single_sidebar fxn close--------------------------------------------------------------*/
    ...
    // $list_item  = $this->get_item_ranks($pId,true);
    $list_item = get_field('add_to_list',$post_id,false);
