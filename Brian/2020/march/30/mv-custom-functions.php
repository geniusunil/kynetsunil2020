<?php
	...
	*/
        ...
        if(!empty($posts))
        {
            ...
            ////       
                   ...
                   // free if(isset($sorts) && $sorts =="free"){
					...
					// echo "postarr1affordable";
					// print_r($postarr1Affordable);
					// asort($postarrAffordable);
					...
					/* 	echo "postarraffordable";
						print_r($postarrAffordable);
						echo "postarr1affordable";
						print_r($postarr1Affordable); */
						// $postarr1Affordable = array_reverse($postarr1Affordable, true);
						// echo "pa and pa 1";
						// print_r($postarrAffordable);
						// print_r($postarr1Affordable);
						// asort($postarrAffordable);
	...
	//QA feature end//
	function add_datapoints_databse($uid,$dptype,$dp)
	{
