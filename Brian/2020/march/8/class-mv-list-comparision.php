						...
						foreach ($basedthings as  $it => $ittitle)
						{
							...
							{         
								...
								<div id="showhide001">
									...
									<div id="series_chart_div_valueformoney_customersupport" style="width: 900px; height: 500px;" class="chartShow "></div>
									<div id="series_chart_div_valueformoney_featuresfunctionality" style="width: 900px; height: 500px;" class="chartShow "></div>
									<div id="series_chart_div_featuresfunctionality_easeofuse" style="width: 900px; height: 500px;" class="chartShow "></div>
									<div id="series_chart_div_featuresfunctionality_customersupport" style="width: 900px; height: 500px;" class="chartShow "></div>
									<div id="series_chart_div_customersupport_easeofuse" style="width: 900px; height: 500px;" class="chartShow "></div>
								</div>
