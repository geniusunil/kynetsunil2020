...
// print_r($total_score_feature_ind_avg);
    ...
    /*------------------------------------------------------section1 complte-----------------------------------------------------------*/
    $details .= '<div class="row"><hr class="hr-line">';
    if($nor > 10){
    ...
    $details .= '<img class="leaf1" src="https://area52.softwarefindr.com/wp-content/uploads/2020/02/leaf3a.png"><div class="awars_sec"> 
