...
/******************************************** faq-2 start ***********************************************/
    ...
    function list_decision_sec($post_id){
        ...
        ?>
            <div class="decision_sec" style="width:  85%;margin:  0 auto;" >
            ...
            <?php $list_data_points = get_data_points_list($main_list_id); 
...
$get_list_name =  get_field( 'list_content_title_singular', $main_list_id );
        ...
        if(!empty($sub_heading)){
         ...
         {
             $list_title = "What is the Best  ".$get_list_name." ?";
...
$year = do_shortcode('[year]');
        ...
        echo '<p align="center">Without further adieu, here are our picks for the item in '.$year.'  according to '.$finalVotes.' users.</p>';
...
<?php
	...
	//getlist filter================/
	  ...
	  $a = array();
		...
		echo "postarr is ".print_r($postarr);
        ...
        if ( ! empty( $posts ) ) {
         ...
         <section id="filter">
                ...
                <div  class="fileter_list" style="height: 135px;display: flex;width: 46%;">
