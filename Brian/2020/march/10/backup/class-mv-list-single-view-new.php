...
//                                                echo '</pre>';
 ...
 <div class="compare_items"> <div style="display:table" ><div style="display:table-row" ><div style="display:table-cell; vertical-align:middle" >Compare the top two solutions: </div>';
    ...
    function get_award_list($post_id){
        ...
        if(!empty($listrankord)){
                        foreach ( $listrankord as $id => $rank ) {  
                            $all_items = get_field("list_items", $id);//count( $listrankord );   
                            $all_item_count = count($all_items);
                            // echo "all item count";
                            // echo $all_item_count;   
                            $all_award_list[$id] = $rank;                       
                        ...
                        foreach($all_award_list as $key => $item_ind_list){                           
                            $award_items[] = "<h4 style='color: #fff;'>".get_the_title($key)."</h4><p style='color: #40ca1a;'>&nbsp; &nbsp;".$i." position out of ".$all_item_count." items</p>";
                    ...
                    $award_position_text = implode(" ",$award_items_position);
