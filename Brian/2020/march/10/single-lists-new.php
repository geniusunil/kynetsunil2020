    ...
    ?>
	    ...
	    <div class="single-list-data zf-item-vote" data-zf-post-id="<?php echo '136923'?>">
            ...
            ?>
              ...
              <div id="app">
                <v-app>
           <?php foreach($features_ratings as $f => $r){
...
<?php 
    ...
    <div class="viewport inview">
      ...
      <rect x="200" y="20" width="20" height="20" rx="5" fill="'.$colorOfOpenSourcePercentage.'" /><text class="detail-text" font-size="20" line-spacing="20" fill="#5BD49C"><tspan x="230" y="40">'.$open_source_percentage_title.' '.$p2show_open_source.'%</tspan></text>';
      ...
      <rect x="200" y="45" width="20" height="20" rx="5" fill="'.$colorOfSubscriptionPercentage.'" /><text class="detail-text" font-size="20" line-spacing="20" fill="#5BD49C"><tspan x="230" y="65">'.$subscription_percentage_title.' '.$p2show_subscription.'%</tspan></text>
      ';
      ...
      <rect x="200" y="70" width="20" height="20" rx="5" fill="'.$colorOfFreemiumPercentage.'" /><text class="detail-text" font-size="20" line-spacing="20" fill="#5BD49C"><tspan x="230" y="90">'.$freemium_title.' '.$p2show_freemium.'%</tspan></text>';
      ...
      <rect x="200" y="95" width="20" height="20" rx="5" fill="'.$colorOfOneTimePercentage.'" /><text class="detail-text" font-size="20" line-spacing="20" fill="#5BD49C"><tspan x="230" y="115">'.$one_time_license_percentage_title.' '.$one_time_license_percentage.'%</tspan></text>
      </g></g>';
