	...
	//getlist filter================/
       ...
       /*  $temp_array=array();
        ...
        // $totalActVOtes = 0;
            ...
            #--------------------------*************************----------------------------------
            echo "globals";
            print_r($_SESSION['gen_list']);
            if(isset($sorts) && $sorts =="free"){
                    $postarr = $_SESSION['gen_list']['free'];
                }elseif(isset($sorts) && $sorts =="affordable_price"){
                    $postarr = $_SESSION['gen_list']['affordable'];
                }elseif(isset($sorts) && $sorts =="User_friendly"){
                    $postarr = $_SESSION['gen_list']['User_friendly'];
                }else{
                    $postarr = $_SESSION['gen_list']['overall'];
                }
             ...
             /*    if ( ! empty( $promoted_list_items ) ) {
                    foreach ( $postarr as $key => $score ) {
                        if ( in_array( $key, $promoted_list_items ) ) {
                            unset( $itmes_with_promoted[$key] );
                            $item->promoted =1;
                            $temp_array[]=$item;
                        }
                    ...
                    <div class="container">
                        <div class="row justify-content-md-center">
                            <div class="col-md-8 center">
                                ...
                                <?php echo "checkpoint7"; if ( ! empty( $static_val ) ) {?>
         ...
         <section id="filter" >
                ...
                <?php $kk = 1;
                    ...
                    foreach($static_val as $key=>$score): // variable must be called $post (IMPORTANT)
                        ...
                        $price_starting_from = (int) filter_var($price_starting_from, FILTER_SANITIZE_NUMBER_INT);
                                                        ...
                                                        <div class="slide" <?php echo $style;?>>
                                                            ...
                                                            ?>
                                                                ...
                                                                <div class="slide_detail">
                                                                    ...
                                                                    elseif( in_array( $list_id, $promoted_list_items )  ){ echo '<div class="purplebadge">Promoted</div>'; }
                                                                    else{
                                               ...
                                               <?php } else {
												...
												?>
                                                    <li class="greya">
                                                        ...
                                                        <div class="<?php if(!in_array( $list_id, $promoted_list_items) && !$tooltipAdded && (round($postarr[$list_id])>=90)) {echo "tooltip"; $notpromotedttscore90 = true; }?>">
                                                            ...
                                                            <?php if($notpromotedttscore90) {echo "<span class=\"visibletooltiptext\">Over ".round($postarr[$list_id])." users downloaded this.</span>"; $tooltipAdded = true;} ?>
                                                        </div> 
                                                        <span >
                                                            <?php
                                                                // echo $list_id;
