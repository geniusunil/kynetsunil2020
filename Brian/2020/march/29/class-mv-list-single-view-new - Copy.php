	...
	//getlist filter================/
	  ...
	  $a = array();
        ...
        $maxsScorePost = $maxsScore[0];
            ...
            #--------------------------*************************----------------------------------
            echo "globals";
            print_r($GLOBALS['gen_list']);
            if(isset($sorts) && $sorts =="free"){
                    $postarr = $GLOBALS['gen_list']['free'];
                }elseif(isset($sorts) && $sorts =="affordable_price"){
                    $postarr = $GLOBALS['gen_list']['affordable'];
                }elseif(isset($sorts) && $sorts =="User_friendly"){
                    $postarr = $GLOBALS['gen_list']['User_friendly'];
                }else{
                    $postarr = $GLOBALS['gen_list']['overall'];
                }
