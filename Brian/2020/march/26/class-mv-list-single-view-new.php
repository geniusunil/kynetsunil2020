        ...
        if ( ! empty( $posts ) ) {
         ...
         <section id="filter" >
                ...
                <div class="row" style="overflow:visible;">
                    <div  class=" col-sm-12 fileter_list" style="height: 70px;width: 80%; overflow: visible;"> 
           ...
           /*  echo "video list new";
            ...
            foreach($video_list_new as $new)
                ...
                //						print_r($splittedstring);
                    ...
                    $details .= '<div class="vid-item '.$active.'" data-url="https://youtube.com/embed/'.$video_list_new[$i].'" data-number="'.$i.'" onClick="document.getElementById(\'vid_frame1\').src=\'https://youtube.com/embed/'.$video_list_new[$i].'?autoplay=1&rel=0&showinfo=0&autohide=1\'">
