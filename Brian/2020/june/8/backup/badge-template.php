...
">
    <div id="topsfbadges" class="top-container">
        ...
        ">
                              ...
                              <textarea id="code" readonly="" rows="5" cols="70" style="resize: none;background-color: #fff;border: 1px solid #ccc;border-radius: 4px;">
                                ...
                                <button style="width:100%" class="sf-button" onclick="copy_to_clipboard()">copy</button>
                              </div>
    ...
    <div class="design">
        ...
        <div id="designs" >
          <div class="row">
            <div class="design-box col-md-4" id="design7">
              <canvas class="selectedReviews canvasR" id="canvas7" width=500 height=500 style="background-color:#fff;"></canvas>
              
            </div>
            <div class="design-box col-md-4" id="design8">
              <canvas class="canvasR" id="canvas8" width=500 height=77 style="background-color:#fff;"></canvas>
            </div>
            <div class="design-box col-md-4" id="design9">
              <canvas class="canvasR" id="canvas9" width=500 height=500 style="background-color:#fff;"></canvas>
          </div>
          </div>
          <div class="row">
            <div class="design-box col-md-4" id="design10">
              <canvas class="canvasR" id="canvas10" width=500 height=500 style="background-color:#fff;"></canvas>
            </div>
            <div class="design-box col-md-4" id="design11">
            <canvas class="canvasR" id="canvas11" width=500 height=134 style="background-color:#fff;"></canvas>
            </div>
            <div class="design-box col-md-4" id="design12">
            <canvas class="canvasR" id="canvas12" width=500 height=134 style="background-color:#fff;"></canvas>
            </div>
          </div>             
    </div>
      ...
      success: function (data)
      {
        ...
        for (const award of awards) {
          award.addEventListener('click', function(event) {
            document.getElementById("design1").innerHTML = '<canvas class="selected canvasA" id="canvas1" width=500 height=500 style="background-color:#fff;"></canvas><p></p>';
            document.getElementById("design2").innerHTML = '<canvas class="canvasA" id="canvas2" width=500 height=500 style="background-color:#fff;"></canvas><p></p>';
            document.getElementById("design3").innerHTML = '<canvas class="canvasA" id="canvas3" width=500 height=500 style="background-color:#fff;"></canvas><p></p>';
            document.getElementById("design4").innerHTML = '<canvas class="canvasA" id="canvas4" width=500 height=500 style="background-color:#fff;"></canvas><p></p>';
            document.getElementById("design5").innerHTML = '<canvas class="canvasA" id="canvas5" width=500 height=134 style="background-color:#fff;"></canvas><p></p>';
            document.getElementById("design6").innerHTML = '<canvas class="canvasA" id="canvas6" width=500 height=134 style="background-color:#fff;"></canvas><p></p>';

            const canvass = document.querySelectorAll(".canvasA")
...
function wrapText(context, text, varObj, maxWidth, lineHeight, fontName) { //https://www.html5canvastutorials.com/tutorials/html5-canvas-wrap-text-tutorial/
          ...
          function draw_canvass_reviews(repeat){
            ...
            document.getElementById("design7").innerHTML = '<canvas class="selectedReviews canvasR" id="canvas7" width=500 height=500 style="background-color:#fff;"></canvas><p></p>';
            document.getElementById("design8").innerHTML = '<canvas class="canvasR" id="canvas8" width=500 height=77 style="background-color:#fff;"></canvas><p></p>';
            document.getElementById("design9").innerHTML = '<canvas class="canvasR" id="canvas9" width=500 height=500 style="background-color:#fff;"></canvas><p></p>';
            document.getElementById("design10").innerHTML = '<canvas class="canvasR" id="canvas10" width=500 height=500 style="background-color:#fff;"></canvas><p></p>';
            document.getElementById("design11").innerHTML = '<canvas class="canvasR" id="canvas11" width=500 height=134 style="background-color:#fff;"></canvas><p></p>';
            document.getElementById("design12").innerHTML = '<canvas class="canvasR" id="canvas12" width=500 height=134 style="background-color:#fff;"></canvas><p></p>';

            const canvassR = document.querySelectorAll(".canvasR")
            for (const canvas of canvassR) {
                canvas.addEventListener('click', function(event) {
                  image = canvas.toDataURL("image/png");
                  ...
                  document.getElementById("windowReviews").innerHTML = '<a target="_blank" href="'+itemUrlR +'" title="ImageName">'+
                                  '<img style="width:'+sliderR.value+'px;" id="previewImgR" alt="ImageName" src="'+image+'">'+
                              '</a>';
                  activeCanvas = document.querySelector('canvas.selectedReviews');
                  if(activeCanvas !== null){
                    activeCanvas.classList.remove("selectedReviews");
                  }
                  canvas.classList.add("selectedReviews");
              ...
              img.onload = function(){
                ...
                // loaded_face holds the loaded FontFace
                  ...
                  wrapText(ctx,"Users Love us!",varObj,canvas.width*133/290,txtheight,fontNow);
              ...
              document.getElementById("windowReviews").innerHTML = '<a target="_blank" href="'+itemUrl+'" title="ImageName">'+
                              '<img style="width:'+sliderR.value+'px;" id="previewImgR" alt="ImageName" src="'+image+'">'+
                               '</a>';
              }
            ...
            sliderR.onchange = function() {
              ...
              if(imageLinkR != ''){
                document.getElementById('codeR').value = '<a target="_blank" href="'+itemUrlR+'" title="ImageName">'+
                              '<img style="width:'+sliderR.value+'px;" id="previewImgR" alt="ImageName" src="'+imageLinkR+'">'+
                               '</a>';
              }
