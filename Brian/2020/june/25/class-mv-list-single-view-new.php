    ...
    public function show_list($content)
    {
        ...
        if (is_singular('lists') && !has_shortcode($content, 'show_list')) 
		{
            ...
            if (!has_shortcode($post->post_content, 'show_list')) 
			{
				...
				foreach($all_sections as $single_all_sections)
				{
					if($single_all_sections == 'geographicAdaption ')
					{
						$content .= '<div class="map-div">' . $this->list_geo_map(get_the_ID()) . ' </div></div>';
					}
					elseif($single_all_sections == 'prosAndCons')
					{
						
						
					}
					elseif($single_all_sections == 'awards')
					{
						
					}
					
					elseif($single_all_sections == 'keyFeatures ')
					{
						
					}
					
					elseif($single_all_sections == 'pricing')
					{
						$content .= '<div class="container item-overview-content">' . $this->list_price_performance_chart(get_the_ID()) . '</div>';
					}
					elseif($single_all_sections == 'priceComparison')
					{
						
					}
					
					elseif($single_all_sections == 'marketOverview')
					{
						
					}
					
					elseif($single_all_sections == 'versus')
					{
						
					}
					
					elseif($single_all_sections == 'alternative')
					{
						
					}
					
					elseif($single_all_sections == 'videos')
					{
						
					}
					
					elseif($single_all_sections == 'support')
					{
						
					}
					
					elseif($single_all_sections == 'faq')
					{
