          ...
          award.addEventListener('click', function(event) {
            ...
            for (const canvas of canvass) {
                canvas.addEventListener('click', function(event) {
                  ...
                  document.getElementById("window").innerHTML = '<a download="saasScout-badge.png" href="'+image+'" title="ImageName">'+
                                  '<img id="previewImg" width="'+slider.value+'" alt="ImageName" src="'+image+'">'+
                              '</a>';
...
function wrapText(context, text, varObj, maxWidth, lineHeight, fontName) { //https://www.html5canvastutorials.com/tutorials/html5-canvas-wrap-text-tutorial/
            ...
            function draw_canvass(repeat){
              ...
              img6.onload = function(){
                ...
                activeCanvas = document.querySelector('canvas.selected');
              var image = activeCanvas.toDataURL("image/png");
              document.getElementById("window").innerHTML = '<a download="saasScout-badge.png" href="'+image+'" title="ImageName">'+
                                  '<img id="previewImg" alt="ImageName" src="'+image+'">'+
                              '</a>';
            ...
            slider.onchange = function() {
              ...
              // image = document.querySelectorAll('#window img');
              
              // document.getElementById("previewImg").width = "300";
              // image.setAttribute('width',slider.value+'px');
