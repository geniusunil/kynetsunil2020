...
/*         echo "list item count";
    ...
    public function price_performance_chart($post_id)
    {
        ...
        foreach ($comared_data as $post_idss) {
            ...
            $tooltips["_" . $post_idss] = '<div style=" margin: 10px;"><b>'.get_the_title($post_idss).'</b> <br> Performance : <b>'.$all_items_fs["_" . $post_idss].'</b><br>Price : <b>$'.floatval($all_price).$freqToPrint.'</b><br></div>';
        }
        // print_R( $all_price_trim);
        // echo "count".count($comared_data);
