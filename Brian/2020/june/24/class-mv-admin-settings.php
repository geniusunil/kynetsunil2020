...
function alternative_page_desc_callback() {
	...
	function comparison_page_list_order_callback() {
		...
		echo '<p class="order">Order of sections to show on Comparison Page. Use lowercase only eg.  overview,betterthan,ratings,features,pricing,map,integrations,support, video, ranking, reviews, pricevsperformance, categoryscore, marketradar,hidden, screenshots, verdict,   </a></p>';
