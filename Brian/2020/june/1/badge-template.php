          ...
          award.addEventListener('click', function(event) {
            ...
            for (const canvas of canvass) {
                canvas.addEventListener('click', function(event) {
                  ...
                  document.getElementById("window").innerHTML = '<a download="custom-filename.jpg" href="'+image+'" title="ImageName">'+
                                  '<img style="width: 100%;" alt="ImageName" src="'+image+'">'+
                              '</a>';
            ...
            var singular_title_original_case = singular_title;
...
function wrapText(context, text, varObj, maxWidth, lineHeight, fontName) { //https://www.html5canvastutorials.com/tutorials/html5-canvas-wrap-text-tutorial/
            ...
            preview_img = function(el) {
              canvas = el.getElementsByTagName("LI")[0]
              var image = canvas.toDataURL("image/jpg");
              el.href = image;
            };
