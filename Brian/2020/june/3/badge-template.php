...
">
        ...
        <div class="preview">
                              ...
                              <button onclick="store_image_get_link()">Generate code</button>
                              <label>You can use this code on your site</label>
                              <textarea class="js-copytextarea batchhtml col-md-12 col-sm-12 col-xs-12 padding10 font13" readonly="" rows="5" cols="70" style="resize: none;background-color: #fff;border: 1px solid #ccc;border-radius: 4px;"><div><a target="_blank" href="https://www.goodfirms.co/directory/platform/app-development"><img style="width:243px" src="https://goodfirms.s3.amazonaws.com/badges/normal-badge/app-development.svg" alt="GoodFirms Badge"></a></div></textarea>
                                <button>copy</button>
        </div>
        </div>
    </div>
      ...
      success: function (data)
      {
        ...
        for (const award of awards) {
          award.addEventListener('click', function(event) {
            // alert("hi");
            document.getElementById("design1").innerHTML = '<canvas class="selected" id="canvas1" width=500 height=500 style="background-color:#808080;"></canvas><p></p>';
            ...
            document.getElementById("design5").innerHTML = '<canvas id="canvas5" width=500 height=134 style="background-color:#808080;"></canvas><p></p>';
            document.getElementById("design6").innerHTML = '<canvas id="canvas6" width=500 height=134 style="background-color:#808080;"></canvas><p></p>';
...
function wrapText(context, text, varObj, maxWidth, lineHeight, fontName) { //https://www.html5canvastutorials.com/tutorials/html5-canvas-wrap-text-tutorial/
          ...
          function store_image_get_link(){
            filename="badge_"+itemid+"_";
            jQuery.ajax(
            {
              url: '<?php echo admin_url('admin-ajax.php') ?>',
              type: 'POST',
              data: {post_id: post_id, action: 'store_get_link'},
              dataType: 'json',
            ...
            slider.onchange = function() {
              ...
              //   ratio=canvas.width/slider.value;
