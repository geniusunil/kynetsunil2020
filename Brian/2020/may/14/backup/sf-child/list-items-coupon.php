...
<div class="content-area mv-alternative" id="primary">
    <div class="alternate-list-items_coupon alternate_upper_header coupon_header">
...
$url = $src[0];		
        ...
        <div class="mv-single-lists coupon_banner">
            <div class="alternate_header row item">
...
<div class="deal_desc">
	<span id ="coupon_date" ></span>
			...
			<p>Copy and paste this code at  <a href="<?php echo $couponlist[$coupon_key]['link']?>"> WP Engine</a> </p>		
	
<p><input type="text"  id ="myInput_copy" value= "<?php 	if(!empty( $couponlist[$coupon_key]['code'])){
					echo $couponlist[$coupon_key]['code'];
				}
				else{
					echo $couponlist[$coupon_key]['title']; 
				}?>" placeholder="Couponcode"><button onclick="myFunctioncopy()" class="copytxt">Copy text</button></p>	
...
<!--	Popup form end-->
						...
						<div class="alternative-page-desc">
							 ...
							 <?php 
										...
										{ 
											echo '<p> Hurry! This special offer ends on ' .$couponlist[$coupon_key]['expdate']; 
										} 
								?> 
							</p>
                        ...
                        <div class="review-bck-btn coupon_reviewbtn ">
							<div class="get_code_btn">
								   
								<button id= "show">Get code & open site</button>
...
-->
							...
							<a  href="" class="btn ls_referal_link" data-parameter="alternative" data-id=""><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></a>
...
<div class="deal_desc">
			...
			<p>Copy and paste this code at  <a href="<?php echo $coupon_item['link']; ?>"> WP Engine</a> </p>		
...
//							echo "<tr class=data><th>".$coupon_item[title]."</th>";
							echo "<th>".$coupon_item[description]."</th>";
							echo "<th>".$coupon_item[expdate]."</th>";
							if ($coupon_deal === 'coupon'){
							echo "<th>".$coupon_item[code]."</th>";
							}else{
...
//							echo $coupon_id;
						...
						<th>
								...
								<button class= "all_pop" data-id="<?php echo $coupon_id; ?>"  >Click Here</button>
<!--
...
<!--------------------------------------------	Popup form end------------------------------------------>
    ...
    color: #5478dc;"></i> Signup for more & similar deals </strong></p><p class= "subsc_coupon_page"><?php echo $subscription_form; ?></p>	
