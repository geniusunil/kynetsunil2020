...
<?php }?>
	...
	// 		$key = $listID." ";
	// 		$listsRevised[$key] = array();
	// 		$listsRevised[$key]['rank']=$rank;
	// 		$listsRevised[$key]['total_items']=0;
	// 		$all_items = get_field('list_items',$listID);
	// 		if(is_array($all_items)){
	// 			$listsRevised[$key]['total_items']=count($all_items);
	// 		}
	// 		$listsRevised[$key]['title']=get_the_title($listID);

	// 	}
	// 	echo json_encode($listsRevised);
	// 	wp_die();
	// }
