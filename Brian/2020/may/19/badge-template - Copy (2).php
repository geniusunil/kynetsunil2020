    ...
    jQuery.ajax({
      ...
      success: function (data)
      {
        ...
        button.addEventListener('click', function(event) {
          ...
          document.getElementById("awardName").innerHTML ='<div class="dropdown">'+
            '<button id="selectAward" onclick="myFunction1()" class="dropbtn">Select Award Type</button>'+
            '<div id="myDropdown3" class="dropdown-content">'+
            '<input type="text" placeholder="Search.." id="myInput" onkeyup="filterFunction()">'+
            '<span style="display: block;" post-id='+post_id+' >List Rankings</span>'+
            '<span style="display: block;" post-id='+post_id+' >Best For</span>'+
            '<span style="display: block;" post-id='+post_id+' >Contender</span>'+        
            '</div>'+
            '</div>';
