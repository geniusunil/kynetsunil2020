...
// echo "item fs $item_fs industry fs $industry_fs";
        ...
        foreach($res as $resultt){
            //     echo "result_123";
            //    echo $resultt;
            $price_all_item11 = get_field( 'price_starting_from', $resultt);
            $price_all_item =(float) filter_var($price_all_item11, FILTER_SANITIZE_NUMBER_INT);
        //     echo $resultt."<br>";
