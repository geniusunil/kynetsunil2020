...
<?php }?>
	...
	function get_awards_by_post_id(){
		...
		// $currentFS = $currentRF = $minFS = $minRF = $maxFS = $maxRF;
		...
		// $awards['market_radar']['currentfs']=$currentFS;
		// $awards['market_radar']['currentFSby12']=$currentFSby12;
		// $awards['market_radar']['currentrf']=$currentRF;
		// $awards['market_radar']['currentFSby12']=$currentRFby12;
		
		/* $currentFSby12OriginInverted = ($maxFS/12)-$currentFSby12;
		$currentRFby12OriginInverted = ($maxRF/12)-$currentRFby12; */
		//check contender
		// x is RF
		// y is FS
		// equation is 3x+y-24=0
		// and x+3y-24=0
		// $awards['market_radar']['minfs']=$minFS;
		// $awards['market_radar']['maxFS']=$maxFS;
		// $awards['market_radar']['minRF']=$minRF;
		// $awards['market_radar']['maxRF']=$maxRF;
