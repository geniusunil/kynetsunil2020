        ...
        for (const award of awards) {
          award.addEventListener('click', function(event) {
            ...
            img3.onload = function(){
              ...
              ctx3.font = txtheight+"px MyriadProRegular";
              // loaded_face holds the loaded FontFace
              ctx3.fillStyle = "#fff";
              ...
              if(singular_title !== null){
                ...
                wrapText(ctx3,completeText,varObj,maxWidth,txtheight);
              }
              else{
                ...
                // console.log("before ranking quota");
                // console.log({varObj});
                adjustLine(ranking_quota,ctx3, varObj, maxWidth, txtheight);
                ...
                ctx3.font = lineHeight+"px MyriadProRegular";
                ...
                console.log("canvas3");
                adjustLine(year,ctx3, varObj, canvas3.width*47/300, lineHeight);
                varObj.y = canvas3.height*220/265;
                ctx3.font = lineHeight+"px MyriadProBold";
                adjustLine(year,ctx3, varObj, canvas3.width*47/300, lineHeight);
