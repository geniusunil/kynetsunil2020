...
// var_dump($catobj );
   ...
   /*              echo "top3 features";
    ...
    /* $i= 1;
    foreach($generated_list[''] as $id=>$score){
...
<?php
                ...
                $list_promoted =  get_field('promoted_list_items',$promotd_list1);

                echo $list_promoted;

                    echo '<div class="col-3">
                    <div class="wrapper ">
                        <div class="featured-title ">fghgfjgf</div>
                        <div class="featured-image">gfjgfjgf</div>
                        <div class="featured-text1"><a href="truutr">fgjgfjgf</a></div>
                        <hr>
                        <div class="featured-text2">findrScore</div>
                        <div class="featured-text3">trytrut</div>
                        <div class="featured-text4"><a href="fgjfg">Read Review</a></div>
                    </div>
                </div>';
?>
    ...
    // echo $generated_list[''][$feature]['rank'];
