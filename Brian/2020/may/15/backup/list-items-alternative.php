...
<p>
            ...
            //    print_r($alterItems); 
               ...
               echo '<li><i class="fa fa-arrow-circle-o-right" style="color: #ff9500; font-size: 13px; float: left; margin: 3px 9px 0 0;"></i>'.get_the_title($list).'</li>';
...
foreach ($item_free as  $q => $abc) {
  ...
  $top1_alternative = get_the_title($alterItems[0]);
  $top2_alternative = get_the_title($alterItems[1]);
  $top3_alternative = get_the_title($alterItems[2]);
  ...
  $list_item = get_field('add_to_list', $mainId, false);
        ...
        $ind_fs = $all_fs_sum / count($all_item_id);
        ...
        // print_r($item_ranks);
        foreach ($item_ranks as $id => $item_list) {
            $noOflistitems = get_field('list_items', $id , false);
           
           $item_pos = array_search($mainId, $noOflistitems);
        break;
...
?>
      <div id="overview">
                 ...
                 <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                     <div itemprop='text'>
                     Ans. Typically when users are looking at $item_name they also look at these competitors $top1_alternative , $top2_alternative and $top3_alternative.
              ...
              $faq .= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                 ...
                 <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                     <div itemprop='text'>
                     Ans. When it comes to $faq_list_name, $item_name is ranked  $item_pos out of $total_items in that category according to  $finalVotes.
              ...
              $faq .= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                 ...
                 <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                     <div itemprop='text'>
                     Ans. {Currently $item_name is well priced on the market} but here are a few similar solutions to consider you can try [best lower price1] or [best lower price 2]. Else: There are cheaper alternatives available but with everything, there is a trade-off, you can try [best lower price1] or [best lower price 2]. We recommend you use our comparison feature to see how they fare against each other.
              ...
              $faq .= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                 <h4 itemprop='name'> Q.   What is a cheaper alternative to $item_name for [top feature]?     </h4>
                 <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                     <div itemprop='text'>
                     Ans. If [top feature] is what is most important to you then you might want to consider [best lower price1 with top feature] or [best lower price 2 with top feature].
              ...
              $faq .= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                 ...
                 <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                     <div itemprop='text'>
                     Ans. If you are after a more user-friendly alternative to $item_name then you might want to consider [item with higher ease of use rating 1] or [item with higher ease of use rating 2] which as a higher ease of use rating than $item_name
