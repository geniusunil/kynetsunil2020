...
echo "<br>list_items ".$count_posts;
echo "<br>total datapoints in site ".$total_datapoints_in_site;
echo "<br>total voters in site ".$total_voters_in_site;
...
/****************************************************** * faq-1 start **************************************************/
    ...
    $faq_Cat = "dummy";//$_SESSION['category_faq'];
    /********************************************************* faq-6 & 7Start ***************************************************/
    $list_id = get_the_id();
