...
//          console.log("ïds");
   ...
   if(sel_arr.length == 2)
   {
    ...
    success: function(data) {
        ...
        // console.log(data.title1);
        jQuery( ".compare_link1" ).append( "<a href='" + data.link + "'>"+
        "<div class='cp-item1' style='width: 36% !important;'><img src='"+data.item_image1+"' style='width: 50px !important; margin: auto;'>"+ 
        "<br><span class='cp-title' style='font-size: 12px;'>"+data.title1+"</span></div> <p style='float: left;position: relative;top: 29px; text-align: center; width: 26%; '>"+
        "<span class='cp-vs-item'><span class='cp-vs-inner-item'>vs</span></span></p> <div class='cp-item1' style='width: 36% !important;'> "+
        "<img style='width: 50px !important; margin: auto;' src='"+ data.item_image2 +"  ' ><br>"+
        "<span class='cp-title' style='font-size: 12px;'>"+data.title2+"</span></div> </div>"+"</a>");
