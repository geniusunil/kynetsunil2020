...
jQuery.ajax({
							...
							type:'POST',
							data: {"action": "infinite_scroll", "page_no": 1, "list_id": <?php echo $list_id; ?>, "sort": "<?php echo $_GET['sort']; ?>"},
							beforeSend: function() {
       ...
       /*  echo "sorts 2";
        ...
        // echo "static val";
        // print_r($static_val);
        $static_val = get_field('list_items', $post_id, false);
        if (!empty($static_val)) {
            ob_start();
            // echo "start inside";
            ?>
...
// echo "2item rating feature";
        ...
        $all_integrated_list =  $this->industry_items;
        if (!empty($all_integrated_list)) {
            ...
            // $integrate_Avg = round(count($total_integrate_list) / count($this->industry_items), 2);
            //  if (!empty($all_integrated_list)) {
            ...
            // echo "ërnd";
            // print_r($all_integratedre );
            foreach ($all_integratedre as $key=> $item) {
            ...
            //   echo $key;
                    ...
                    $key_feature_result .= "<strong><span>" . $integarte_item_name . "</strong></span></div></div>";
                    $key_feature_result .= ' </div>';
                    } else{
                ...
                // }
                $key_feature_result .= '<h5 style="font-weight:600; cursor: pointer;" id="seeMore_2">See More</h5>'; 
	...
	<script>
									...
									jQuery("#seeMore_2").click(function()
									{
										jQuery(".hide_li_2").toggle();
									});
								</script>
...
echo "all item id pricing chart end"; */
        ...
        $pricing_result .= '<div class="col-sm-12"> ';
        ...
        $pricing_result .= '<div class="col-sm-3"> ';
