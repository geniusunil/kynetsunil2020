...
//    $i=0;
    ...
    public function list_contnet($listId)
    {
        ...
        $this->datapoints = get_data_points_list($main_list_id);
        ...
        $htm = '<div class="headr_Sec_div" style="width: 87%;margin: 0 auto;"><div class="container-fluid list_overview_sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-10 contenttext"><div id="list_main_contnet">' . $contentP . '
         ...
         We bought '.$total_items.' of the best '.$title_plural.' available in '.date("Y").', put them through a stringent series of examinations with the help of '.$finalVotes.' voters like you, and assigned them FindrScores, all to help you make a smarter decision.  
</span></p>
...
<p class="p1">     So whether you\'re looking for the cheapest, easiest to use, the best overall we ‘ve got you covered. 
         ...
         <p class="p1">   <a href="'.get_permalink().'?lang=GB" >Filter by '.get_the_title().' in United Kingdom</a> – See what users from this country recommends
         </p> <p class="p1"> <a href="'.get_permalink().'?lang=IN" >Filter by '.get_the_title().' in India</a> – See what users from this country recommends
         </p> <p class="p1"> <a href="'.get_permalink().'?sort=free#filter" >Filter by free '.get_the_title().'</a> – See which is the best free solution.
         
         </p> <p class="p1"> <a href="'.get_permalink().'?sort=affordable_price#filter" >Filter by cheapest '.get_the_title().'</a> – See which is the most affordable solution.
        ...
        if (!empty($all_integrated_list)) {
           ...
           // foreach($item as $idd){
            //   echo $key;
                    ...
                    if($key < 4){
                        $key_feature_result .= '<div class="col-sm-6" > <a href="'.get_the_permalink($idd).'"><div class="col-sm-5 integrate_img">';
                        ...
                        $key_feature_result .= '<div class="col-sm-6 hide_li_1" > <a href="'.get_the_permalink($idd).'"><div class="col-sm-5 integrate_img">';
...
$performance_chart_result .= ' <div class = "div_img"><div id="list_price_chart"></div></div>';
    ...
    public function list_comparion_data_show($post_id)
    {
       ...
       $list_comparion_data .= '<div class="comparison-box-list col-sm-5  compare_link1"></div>';      ?>
      <?php
    ...
    public function data_item_page($post_id)
    {
        ...
        $findrScore = $this->findrScore;
        $item_result .= ' <div class="item-overview-content">';
        $item_result .= '<div class = "item-findrscore item-sec-div" id="avgfindrscore">';
        $item_result .= '<h3>Average FindrScore in this Category</h3>';
        //-----------------Average findrscore in this category chart start--------------------------------
...
$item_result .= '</div>'; //item-map div
    ...
    public function adaptation_of_geo_map($post_id)
    {
        ...
        // $post_id = get_the_id();
        // echo $post_id;
        $item_result .= '<div class = "item-map item-sec-div mapp-sec" id="geographicapaption">';
        $item_result .= '<h3>Adaptation by Geography </h3>';
...
////////////////////////////Graphs_end/////////////////////////////////////////////////////////
         ...
         */if (isset($url) && !in_array($url, $video_list_new)) {
            ...
            if(!empty($this->keyfeature_pricing)){
            ...
            if(!empty($this->data_item_page)){
            $this->array_head['avgfindrscore'] = 'Market Overview';
            }
            
            $this->array_head['compare'] = 'Verus';
        ...
        $this->array_head['rwp-users-reviews'] = 'Reviews';
...
// $item_title = get_the_title($post_id);
    ...
    // </div>";
        $conlast = '<div id="overview">
                        ...
                        <div>
                          <span itemprop="description">'.substr($contentP, 0 ,500 ).'...</span>
