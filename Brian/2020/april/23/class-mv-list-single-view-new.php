...
$performance_chart_result .= ' <div class ="graph_text" ><div class="textgraph" style="text-align: left;">';
        ...
        $performance_chart_result .= ' <div id="price-comp" class = "div_img chart-padding"><div id="scatterchart_material"></div></div>';
                ...
                function drawSeriesChart_7()
                {
                    ...
                    var options = {
                        chartArea: {
                            ...
                            height:500,
                        title: \'\',
                        hAxis: {title: \'Research Frequency\', gridlines: {color: \'transparent\'}, textPosition: \'out\', ticks: [{v:0, f:\'Weak\'}, {v: rangeX.max-10, f:\'Strong\'}]},
