...
$html = ob_get_contents();
    ...
    public function get_item_sidebar($post_id)
    {
        ...
        $sidebar .= '<p class="visit_btn_sec"><a href="'.$this->affiliate_url.'" class="visit_btn">' . $this->affiliate_button_text . ' <i class="fa fa-lock"></i> </a></p>';
...
// echo "all total average score";
        ...
        $details .= '<div class="col-sm-12"> <div class="rating-count">' . $rating_item . '</div>
                                            ...
                                            ';
        $details .= $conlast;
        $details .= '<p class="visit_btn_sec"><a href="'.$this->affiliate_url.'" class="visit_btn">' . $this->affiliate_button_text . '<i class="fa fa-lock"></i></a></p>';
