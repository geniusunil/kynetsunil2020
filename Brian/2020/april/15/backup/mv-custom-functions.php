...
">
 ...
 ?>
  <v-tab-item>
    <v-card flat>
      <v-card-text><?php echo $proscons ?> </v-card-text>
    </v-card>
  </v-tab-item>  
  <?php 
...
?>
<div id="rating" class=" item_list_content_sec">
<?php $ease_average_sr = ($ease_average * 10);
...
<div class="progress">
	...
	<span style="position: absolute; top: 24px; width: 100%; left: calc(<?php echo $functionality_feature_average_sr; ?>% - 40%); font-weight: 100;
