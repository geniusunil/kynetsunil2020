...
//    $i=0;
    ...
    public function list_contnet($listId)
    {
        ...
        $htm = '<div class="container headr_Sec_div" style="margin: 0 auto;"><div class="container-fluid list_overview_sec">
            <div class="container">
                <div class="row">
            ...
            if ($scroll == "numeric") {
                if ($total_pages > 1) {
                    ...
                    echo "</div></div></div>";
                        ...
                        <div id="ajax-response" class="container"></div>
...
$performance_chart_result .= ' <div class ="graph_text" ><div class="textgraph" style="text-align: left;">';
    ...
    public function list_avg_cat_fndrscore($post_id)
    {
        ...
        $item_result .= '<div class="_30_3B" style="max-width: 75% !important;  margin: 0 15px;">
                <div class="_27_Cy">
                    <div class="_2mh2-"> </div>
                    <ol class="_2iCXM">
...
" class="leaf1" src="https://area52.softwarefindr.com/wp-content/uploads/2020/02/leaf3a.png"><div class="awars_sec">
    ...
    public function full_content($post_id)
    {
        ...
        $data_all_page .= '<div class="item_list_page_container">' . $this->support_sec($post_id) . '</div>';
