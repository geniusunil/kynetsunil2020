...
// echo "awaard list";/
        ...
        "><img src="' . esc_url( plugins_url( 'image/leaf4a.png', dirname(__FILE__) ) ) . '" class="award_leaf">'.$total_award.'  Awards<img src="' . esc_url( plugins_url( 'image/leaf4b.png', dirname(__FILE__) ) ) . '" class="award_leaf">';
        $ranked_result .= '</div>';
        $ranked_result .= '<div class = "col-sm-6"> ';
    }

        //col-sm - 4 close
        $ranked_result .= '<div class = "col-sm-6" style="  text-align: center;"> ';
