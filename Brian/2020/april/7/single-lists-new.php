...
// var_dump($catobj );
    ...
    // echo $generated_list['overall'][$feature]['rank'];
...
/* foreach($_SESSION['gen_list'][$list_id]['overall'] as $key=>$value){
    $bestoverall = $key;
    break;
} */   
...
// print_r($qalist);
    foreach($qalist as $faq_ls){
        ...
        $faq.=$custfaq;
          ...
          ";
        $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  Which is commonly used for ".$top3features[0]." ? </h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
...
"; 
          ...
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  What is the ".$faq1_best." in $top_loc_key? </h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
