...
function alternative_page_desc_callback() {
	...
	function comparison_page_list_order_callback() {
		...
		echo '<p class="order">Order of sections to show on Comparison Page. Use lowercase only eg. "overview, betterthan, ratings, pricing, features, support, reviews, screenshots, video, download, ranking" </a></p>';
