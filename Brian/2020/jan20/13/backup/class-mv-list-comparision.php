...
//                var_dump($attached_items);
    ...
    public function get_sections(){
        return array('overview'=>'','hidden'=>'','betterthan'=>'','ratings'=>'Ratings','pricing'=>'Pricing','features'=>'Features','support'=>'Support','reviews'=>'Reviews','screenshots'=>'Behind the scenes','video'=>'Video Review','download'=>'Get it Here','ranking'=>'Ranked in these collections');
    }
    ...
    public function get_column_betterthan($post_id,$item,$post_id2){
        ...
        <div class="title-head">
            ...
            foreach($features_ids as $id_s){
                $terms = get_the_terms($id_s, 'list_categories');
                foreach($terms as $term) {
                    echo '<a class="cat-bg" href="'.esc_url( get_term_link( $term->term_id ) ).'" >'.$term->name.'</a>';
               }
             } 
echo "</div> ";
...
//                }
  ...
  <ul class="slides">';
    ...
    public function get_coloumn_faq($post_id,$item,$post_id2){

        $score_1 = $this->findrScoreArr[item1];
        $score_2 = $this->findrScoreArr[item2];
        echo($score_2);
        ...
        $faq .= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'>Q. Is ".get_the_title($post_id)." better than ".get_the_title($post_id2)."?</h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                            Ans. We have anaylze x data points to answer this question, in [year] ".get_the_title($post_id)." is better than ".get_the_title($post_id).".
                            the ".get_the_title($post_id)." scoring [findrscore] whilst ".get_the_title($post_id2)." scored [findr score]
                             </div>
                        </div>
                    </div>
                    ";
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  For beginners which is better ".get_the_title($post_id)." or ".get_the_title($post_id2)."? </h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                            Ans. We ask this very question to our readers and the results are in, ".get_the_title($post_id)." scored better that
                            ".get_the_title($post_id2)." by x points crowing it the most user friendly.
                             </div>
                        </div>
                    </div>
                    ";
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  What's the price difference between ".get_the_title($post_id)." and ".get_the_title($post_id2)."?</h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                            Ans. If pricing model the same: Looking at the starting price of these two solutions [item] is [price and pricing model]
                             which [item] is [price and pricing model]. So on the entry level [item] is $X more per month. 

                            Else different model: The solutions are priced slightly different so calculating the price would need to be over a set period. [item] is [price and pricing model] whilst [item] is [price and pricing model],
                    ...
                    ";
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  What is the difference between ".get_the_title($post_id)." and ".get_the_title($post_id2)."?</h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                                Ans. The main difference beyond price and support, is ".get_the_title($post_id)." has an overall higher FindrScore which looks at over x data points powered by real user testing and overall satisfaction.
                             </div>
                        </div>
                    </div>
                    ";
          $faq .= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q. Out of ".get_the_title($post_id)." and ".get_the_title($post_id2)." which as the better support?</h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                            Ans. The data gathered shows that ".get_the_title($post_id)." as a slightly better user satisfaction that ".get_the_title($post_id2)."
                             </div>
                        </div>
                    </div>
                    ";
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.   What are a few good alternatives to ".get_the_title($post_id)." and ".get_the_title($post_id2)."? </h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                            Ans. Users who research [item a] and ".get_the_title($post_id2)." also look at [alternative 1] which as a FindrCsore of X, 
                            <a href=”link to alternative page”>See [number] more similar solutions</a>
                             </div>
                        </div>
                    </div>
                    ";
          ...
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                    <h3 itemprop='name'> Q.  ".get_the_title($post_id)." or ".get_the_title($post_id2)." which is good for beginners?</h3>
                    <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                        <div itemprop='text'>
                            Ans. Looking at the scorecard for both these products, the results show that [item] is better for beginners
                         </div>
                    </div>
                </div>
                "; 
          ...
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  Which is better, ".get_the_title($post_id)." or ".get_the_title($post_id2)." in ".date("Y")."? </h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                                Ans. We’ve asked this very question to users like you and the results are in. 
                                The majority of users are recommending ".get_the_title($post_id).".
                             </div>
                        </div>
                    </div>
                    "; 
          ...
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                    <h3 itemprop='name'> Q.  How does ".get_the_title($post_id)." compare to ".get_the_title($post_id2)."? </h3>
                    <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                        <div itemprop='text'>
                        Ans. The main difference beyond price and support, is [item] has an overall higher FindrScore 
