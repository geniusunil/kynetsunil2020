...
//  $faq1 = echo do_shortcode("[list_title]");
// if($webinar == ''){
...
// $queried_object = get_queried_object(); 
// price_starting_from
$fjh = get_field('price_starting_from', $list_id);
...
/********************************************************* faq-2 END ***************************************************/
    $faq = ' <div itemscope itemtype="https://schema.org/FAQPage">';
          $faq .= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  What is the $faq1</h3>
          ...
          ";
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  What is the [best webinar service] with [feature]? (do for top 3 features) </h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
          ...
          ";
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  What is the [best webinar service] in [top location]? </h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
          ...
          ";
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  Which are the [best SEO tools] for a beginner? </h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                                Ans. The provider with the best score for ease of use is [top item for ease of use]
                            </div>
                        </div>
                    </div>
          ";
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.   Does GoDaddy or [item] have [top 1 feature]?
                        </h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
          ...
          ";
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.   Does GoDaddy or [item] have [top 2 feature]?</h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
          ...
          ";
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  Does GoDaddy or [item] have [top 3 feature]? </h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                                Ans. 
                            </div>
...
$faqs = '<div id="overview">
 ...
 <div>
   <span itemprop="description">'.get_list_faq().'</span>
 </div>
</div>
';
