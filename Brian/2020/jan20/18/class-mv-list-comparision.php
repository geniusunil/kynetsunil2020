    ...
    public function get_coloumn_faq($post_id,$item,$post_id2){
        ...
        $faq .= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        ...
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                            Ans. We have anaylze ".$x." data points to answer this question, in ".date("Y")." ".$winner." is better than ".$loser.".
          ...
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        ...
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                            Ans. Users who research ".$winner." and ".$loser." also look at ".$alter." which as a FindrCsore of X, 
                            <a href='".get_permalink($this->alternate)."'>See [number] more similar solutions</a>
                             </div>
                        </div>
                    </div>
                    ";
