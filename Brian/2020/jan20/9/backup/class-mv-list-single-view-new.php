...
class Mv_List_Single_View_New {
    ...
    function get_faqs(){
         $iem_name65 = get_the_title( $post_id );
        $beginners ='';
  ...
  echo "faq post id $post_id";
          ...
          $faq = " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  Is $iem_name65 good for beginners?</h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                            Ans. $beginners $post_id
                             </div>
                        </div>
                    </div>
          ";
          ...
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        ...
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                            Ans. You can expect to pay around [starting price]/per month/one time fee (ELSE) is free to use.
                             </div>
                        </div>
                    </div>
          ";
          ...
          ";
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  Is there any coupons for x? </h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                                Ans. Yes there are a few coupons you can try here: [link to coupon page]
                                Else: There are no record on our system of $iem_name offering coupons historically.                                
                            </div>
                        </div>
                    </div>
          ";
          ...
          ";
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.   Can I try x for free? </h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
                            Ans. Yes there is a free trial available which should give you enough time to test out [item] to see if it’s the right fit for you.
                                Else: The isn’t a mention of a free trial on our system but you can always check to see it a money back guarantee is on offer with [item].
                            </div>
                        </div>
                    </div>
          ";
          $faq.= " <div itemscope itemprop='mainEntity' itemtype='https://schema.org/Question'>
                        <h3 itemprop='name'> Q.  Are there any Free alternative to x?</h3>
                        <div itemscope itemprop='acceptedAnswer' itemtype='https://schema.org/Answer'>
                            <div itemprop='text'>
