...
$sidebar .= '<li><i class="fa fa-square"></i> Overview</li> <li><i class="fa fa-square"></i> Videos</li> 
<li><i class="fa fa-square"></i> Pricing</li> <li><i class="fa fa-square"></i> Screenshots</li> 
<li><i class="fa fa-square"></i> Pros & Cons</li> <li><i class="fa fa-square"></i> User Reviews</li> <li><i class="fa fa-square"></i> Ranking</li>';
...
';
        ...
        $details .= '<div class=" item-description container"><div class="col-sm-6 item_list_image_sec"><div class="col-sm-4 img_item">';
        $img = get_the_post_thumbnail( $post_id, 'medium', array('itemprop' => 'image'));

      
        $details .= ''.$img.'</div> <div class="col-sm-2 item_rank_score"> FindScore 
        79/100</div><br/>';
        ...
        $details .=' </div >';
        $details .= '<div class="col-sm-6 item_list_content_sec">';
        $details .='<div class="item-description "><div class="col-sm-6 price_feature"> Accounting Features <br>Ease of use</div>';
  
// Customer Service
$details .='<div class="col-sm-6 price_feature">Cost <br> Customer Service</div> </div>';
$details .='<div class="col-sm-12 item_content_sec2"><strong>Best For: </strong>
...
<li><i class="fa fa-square"></i> Customer Support</li>
        ...
        $details .= '</div></div> <div class="user-rat-sec"><div class="rat-section">'.$rating_item.'</div>
        <div class="user-rating-cont">
        (User Rating)</div></div><hr class="hr-line"> ';
