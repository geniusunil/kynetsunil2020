...
$item_result .= '<div class="box1"><ul>';
$item_result .= 'Country <li> '.$country_name .'</li>';


$item_result .= '</ul></div>';


// $item_result .= '<div class="box2"> ';
// $item_result .= 'Usage';
// $item_result .= ''.$downloads1.'';
// $item_result .= '</div>';
// $item_result .= '</div>';
...
<?php
      ...
      $item_result .= '</div>'; //item-map div
        ...
        $item_result .= '<div class = "item-pricing-model-map item-sec-div">'; //pricing model map start
        $item_result .= '<div class="charts_graph doughnut">
        ...
        $item_result .='     <div class="pricegraph_item" style="padding-top: 50px;">
...
//						print_r($splittedstring);
       ...
       $mapped_support = array();
        ...
        $item_result .= '</div>';
        $item_result .= '<div class = "col-sm-6">';
        $item_result .= '</div>';
        $item_result .= '<div class = "col-sm-2">';
        $item_result .= '</div>';
        ...
        $item_result .= '<p>Looking at data gathered on our platform the industry average for this category is
         [insert avg support rating]% satisfaction rate which means 
         [both items a and b is above this category average/ both item a and b is below this category average] 
         else [item a is below this threshold and item b is above this threshold]</p>';
        $item_result .=' </div>';
...
//-------------------------------------------------------------------------------
       ...
       if(!empty($video_list_new)){ 
          ...
          /*   echo "video_list_new";
            ...
            echo "firstvid";
            print_r($firstvid); */
            $details .='<div class="main_video_class ">';
