...
$deal_link_select = get_site_url().'/deal/?cat='.$category->name;
			
		?>
		<a href="<?php echo $deal_link_select;?>"></a>
	<?php
				}	
...
if($i<4){
		...
		echo "<div class='cpn_list'><a href= '$deal_link' data-id='$cat_id' data-url= '$cat_link' data-name= '$term->name' class='all_cat_name' data-page='1'  data-search = '$deal_search' data-post ='$var'>".$term->name."</a></div>";
...
//		print_r($couponlist);
	...
	<div class="view_coupon"><div class="all_coupn_btn" id ="view_coupn_btn" data-startpage="1"  data-uri="<?php echo $link_url ?>"> 
