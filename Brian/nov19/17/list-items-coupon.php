...
-->
    ...
    top: -320px;
"> <!-- main container -->
    <div class="mv-single-lists coupon_banner" style="
    height: 320px;">
...
">
                                                        ...
                                                        <li class="spinner-list"><span class="cp-vote_count" data-cp-coup-id="<?php echo $couponlist[$coupon_key][id]; ?>" data-cp-votes="<?php echo number_format((float)$couponlist[$coupon_key][votes],1); ?>">
...
including <?php echo $post->post_title; ?>.
	
	
	</p>
	<p><?php echo $cpn_form; ?>
    <!-- <span class="list_box_coupon">Subscribe</span></p>
    ...
    <div class="alternate-list-items alternate_upper_table">
        <div class="mv-single-lists">
            ...
            <div class="alternate-table">
                ...
                <?php echo $subscription_form; ?></div>	
...
//					echo $content;
   ...
   display: flex;
    margin-left: auto;
    width: fit-content; https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins 
"><div class="m-5"><iframe src="https://www.facebook.com/plugins/share_button.php?href=<?php echo urlencode("http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"); ?>%2F&layout=button&size=small&width=67&height=20&appId" width="67" height="20" style="border:none;overflow:hidden;" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe></div>
<div class="m-5"><a style="margin:5px;" href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-show-count="false">Tweet</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script></div>
                 <div class="m-5"><button onclick="myFunction()" style="
    height: 20px;
    font-size: 12px;
    color: white;
    background: gray;
    ...
    <i style="
    margin: 0 5px;
" class="fa fa-link"></i>copy link </button></div> </div>
...
including <?php echo $post->post_title; ?>.
	...
	<?php   ?> </div> 
		...
		<?php } ?>
                           <table class="coupon_table_unique"  class ="item_table">
