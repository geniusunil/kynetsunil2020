    ...
    if(!empty($couponlist)){
		...
		if(!empty($couponlist) && is_array($couponlist)){
            ...
            foreach ($couponlist as $coupon){
                ...
                if(!empty($coupon)){
                            $allIdsvsVotes[$coupon[id]] = $coupon[votes];
                    // for($j=0;$j<count($coupon);$j++){
                           ...
                           /*  $coupondateshow = ($coupon[showDate]=="show")? "selected":"";
                            ...
                            echo '<li><label> Coupon : </label><span class="remove_coupon">X Remove Coupon</span></li>';
                            ...
                            echo '<li data-mh="feat_li"> <label> Expiry date : </label><input type="text" name="old_coupon_expiry_date[]"  value="' . $coupon[expdate]. '" id="feat_'.$key.'" '.$checked.' required></li>';
