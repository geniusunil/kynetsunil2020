...
/*Add Coupon template*/
function mv_custom_coupon_route_template( $template ) {
...
add_filter( 'template_include', 'mv_custom_coupon_route_template' ) ;
...
function wpse26388_rewrites_init() {
    ...
    $pid  = $page->ID;
file_put_contents("alternativ1.txt",$pid,FILE_APPEND);
    add_rewrite_rule(
...
function coupon_init() {
    ...
    $pid  = $page->ID;
file_put_contents("alternative_coupn.txt",$pid,FILE_APPEND);
    add_rewrite_rule(
...
function alter_alternative_page_title( $title ) {
...
add_filter( 'wp_title', 'alter_alternative_page_title', 200 );

add_filter( 'wpseo_title', 'alter_alternative_page_title', 200 );



function alter_alternative_page_description( $description ) {
...
add_filter( 'wpseo_metadesc', 'alter_alternative_page_description', 200 );


/* coupon title and meta data satrtt*/
...
/*------------------------ coupon title and meta data end------------------------------------------------------  */
/**
                                    ...
                                    <div class="productbox zf-list_item"><?php if($availability == 'no') { echo "<div class='pos-relative'><div class='text-overlay'></div>"; } ?><p class="badge list-other-badge"> 
                                        ...
                                        <div class="supportcontact">
                                            ...
                                            <ul class="pull-right">
												...
												<li class="greya"><a href="<?php echo get_the_permalink( $list_id )?>coupon/" class="alter-btn getbtn" data-parameter="itemid" data-id="<?php echo $list_id ?>" >Coupon</a></li>
                                               <?php } else {
