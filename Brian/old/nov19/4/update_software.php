...
//		$html_before_form .= '<dt class= "review_title">' . $field['label'] . '</dt>';
        ...
        $html_before_form .= '<div id="couponForm" class="'.$class.'">
            ...
            $html_before_form .= '<div class="coupons_container post_edit_page"><span class="add_new_coupon">Add Another Coupon</span> <ul>
                    ...
                    foreach ($couponlist as $coupon){
                        ...
                        if(!empty($coupon)){
                            // for($j=0;$j<count($coupon);$j++){
                                    ...
                                    $html_before_form .= '<li><label> Coupon : </label></li>';
                                    $html_before_form .= ' <li><label> Coupon Type : </label></label><select class="coupdeal" name="old_coupon_type[]" ><option value="coupon" '.$coupontypecoupon.'>Coupon</option><option value="deal"  '.$coupontypedeal.'>Deal</option></select><span class="remove_coupon">X</span></li>';
                                    ...
                                    $html_before_form .= '<li class="'.$cdclass.'"> <label> Expiry date : </label><input type="text" name="old_coupon_expiry_date[]"  value="' . $coupon[expdate]. '" id="feat_'.$key.'" '.$checked.' required></li>';
         ...
         */
            ...
            $html_before_form .= '<div class="coupons_container post_edit_page"><span class="add_new_coupon">Add Another Coupon</span> <ul></ul></div>';
...
'</select></li>'+
'<li class="expdate"><label> Expires : </label><input type="text" name="new_coupon_expiry_date[]"  value="" required> </li>');
