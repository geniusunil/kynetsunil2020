...
jQuery(function($){
    ...
    var setCpVoteCount = function(data, isAdd){
        ...
        var current = $(".cp-vote_count[data-cp-post-id='"+data.post_id+"']").attr('data-cp-votes');
        ...
        $(".cp-vote_count[data-cp-post-id='"+data.post_id+"']").attr('data-cp-votes', next);

        $(".cp-vote_count[data-cp-post-id='"+data.post_id+"'] .cp-vote_number").html( next );
    ...
    $(document).on("click", ".cp_vote_down", function(e){
        ...
        $(this).closest('.cp-item-vote').addClass('zf-loading');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(".cp-vote_count[data-cp-coup-id='"+data.coup_id+"']").closest('.cp-item-vote').removeClass('zf-loading');
