...
jQuery(function($){
    ...
    /* Add review stars to header



    var editor_review = $('span.rwp-overlall-score-value').text();

    var editor_score = Math.ceil(editor_review);

    $('.editor-rating-cont label').each(function(index){

    	if( index < editor_score ){

    		$(this).removeClass('filter_stars_unfilled')

    		$(this).addClass('filter_stars_unfilled')

    	}

    })

       var user_review = $('span.rwp-users-score-value').text();



        var user_score = Math.ceil(user_review);
...
// jQuery(document).on('click','.vid-item',function () {	
//	 
//	var link = this.getAttribute("data-videolink");
//	
//	 console.log(this.getAttribute("data-videolink"));
//	  var video = jQuery(this).parents(".vid-main-wrapper").find("#vid_frame");
//	 document.getElementById('vid_frame').src = link;
//	 
////	 var video = jQuery(this).parents(".vid-main-wrapper").closest("#vid_frame").append(this.getAttribute("data-videolink"));
//	 	
//console.log(video);
//	
//	
