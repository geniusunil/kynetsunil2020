jQuery(document).ready(function () {
    ...
    jQuery(document).on('click','.add_new_coupon',function () {
        ...
        jQuery(this).closest('.coupons_container').find('ul').append(' <li><label> Title : </label><input type="text" name="new_coupon_title[]"  value=""> <span class="remove_coupon">X</span></li>');
