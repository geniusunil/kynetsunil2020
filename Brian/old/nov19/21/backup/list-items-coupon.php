...
-->
		...
		<p class="subsc">Did this help you save money?   <ul  class="subsc_vote cp-item-vote thumbs" data-cp-coup-id="<?php echo $couponlist[$coupon_key][id]; ?>" data-cp-post-id="<?php echo $post->ID ?>">
				...
				<p>Subscribe to the Best of RetailMeNot to never miss a deal from 100s of retailers,including 
...
<!-------------------------------------------------------What user are saying section-------------------------------------------------->
    <div class="alternate-list-items alternate_upper_ new_list">
        <div class="mv-single-lists">
            <div class="section_head">
               	<h3 class="rating_label">What user are saying:</h3>
				<?php 
				//start------------------------------------------------------------------
			$post_id = get_the_id();
...
//			echo $count;
        if(!$count){
			?>
            <div class='no-data'>No Reviews Submitted</div><?php
        }else{				
        ...
        <ul class="rev-list-ul coupon_review">
                        ...
                        <div class="rev-detail">
                            ...
                            <div class="rev-user">
                                ...
                                <div class="img-beside">
                                    ...
                                    <h3 class="rat-title"> <?php echo $rev['rating_title']?></h3></div>
                            </div>
                            <div class="rev-detail">
