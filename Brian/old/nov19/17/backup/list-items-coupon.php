...
<!--------------------------------------------	Popup form end------------------------------------------>
            ...
            <div class="alternate-table">
                ...
                <div class="subsc "><strong><i class="fa fa-map-marker" aria-hidden="true" style="    font-size: 22px;
    color: #5478dc;"></i> Signup for more & similar deals </strong><?php echo $subscription_form; ?></div>	
