            ...
            foreach ($couponlist as $coupon){
                ...
                if(!empty($coupon)){
                    // for($j=0;$j<count($coupon);$j++){
                            ...
                            echo '<li data-mh="feat_li"><label> Title : </label> <input type="text" name="new_coupon_title[]"  value="' . $coupon[title]. '" id="feat_'.$key.'" '.$checked.'></li>';
                            echo '<li data-mh="feat_li"><label> Description : </label> <input type="text" name="new_coupon_description[]"  value="' . $coupon[description]. '" id="feat_'.$key.'" '.$checked.'></li>';
                            echo '<li data-mh="feat_li"><label> Coupon code (if any) : </label> <input type="text" name="new_coupon_code[]"  value="' . $coupon[code]. '" id="feat_'.$key.'" '.$checked.'></li>';
                            echo '<li data-mh="feat_li"> <label> Expiry date : </label><input type="text" name="new_coupon_expiry_date[]"  value="' . $coupon[expdate]. '" id="feat_'.$key.'" '.$checked.'></li>';
                            echo '<li data-mh="feat_li"> <label> Expiry date : </label><input type="text" name="new_coupon_expiry_date[]"  value="' . $coupon[expdate]. '" id="feat_'.$key.'" '.$checked.'></li>';
                            echo '<li data-mh="feat_li"> <label> Expiry date : </label><input type="text" name="new_coupon_expiry_date[]"  value="' . $coupon[expdate]. '" id="feat_'.$key.'" '.$checked.'></li>';
