...
class Mv_List_Single_View_New {
    ...
    //geniusnuil
    private $targetCountries=array('IN','US','GB'); // array of countries for which we want to show modified lists and change url attribute ?lang=IN
...
//                                                echo '</pre>';
				...
				/* echo paginate_links( array(
                    ...
                    if($scroll == "numeric"){
                        ...
                        <div class="ajax-ele" style="text-align: center;"> 
                          <button id="loadmore" data-startpage="<?php echo $current_page+1 ?>" data-location="<?php echo $location ?>" data-uri="<?php echo $_SERVER['REQUEST_URI']; ?>"  class="getbtn" style="border:none">Load More</button>  
            ...
            <?php	}else{ ?> 
                        <div id="ajax-response"></div>
                         <div id="nopostmessage"></div>
                         <div class="ajax-ele" style="text-align: center;"> 
                            <img id="infinite-loader" data-startpage="<?php echo $current_page+1 ?>" data-location="<?php echo $location ?>" data-uri="<?php echo $_SERVER['REQUEST_URI']; ?>" src="<?php echo $site_url; ?>/wp-content/uploads/2019/04/ajax-loader-1.gif" />
                         </div>
            <?php	}
                  ?>
            ...
            <div class="title-rating-cont" id="review-title">
                ...
                <div class="title-other-container">
                    ...
                    <div class="item-links">
                        ...
                        ?>
                         <?php if($availability == 'no') { ?>
                            <a href="<?php echo get_the_permalink( $post_id )?>alternative/" class="alter-btn head-links" data-parameter="itemid" data-id="<?php echo $post_id ?>" >Alernative</a><?php } else { ?><a class="mes-lc-li-down aff-link head-links" href="<?php echo $afflink; ?>" rel="nofollow" target="_blank"><?php echo $btntext; ?></a><?php } ?><a id="go-to-user-comments" class="custom-link head-links" href="javascript:void(0)" rel="nofollow" target="_blank">Write a Review</a>
                    </div>
                </div>
