...
// coupon feature start //
 ...
 function re_setup_coupon_list(){
    // echo "inside re setup coupon list";
...
//    var_dump($terms);
    ...
    $couponlist  = get_post_meta($post_id, 'coupon_list', true);
...
$couponlist  = get_post_meta($post_id, 'video_list', true);
 ...
 function re_save_coupon_meta_boxes($post_id, $post, $update){
    ...
    if(isset($_POST['coupons_list']))

    {

        $meta_box_value = $_POST['coupons_list'];
