...
Class Email extends CI_Controller 
{
	...
	public function send_email()
	{
		...
		*/
		...
		{
			$existing_filename =  $this->input->post('existing_filenam');
		}
		...
		if($this->email->send()) 
		{
			...
			if($action !== false)
			{
				...
				if(isset($existing_filename))
				{
					$myfile     = file_put_contents('Conversation_'.$existing_filename, $saved_mail.PHP_EOL, FILE_APPEND);
				}
				else
				{
