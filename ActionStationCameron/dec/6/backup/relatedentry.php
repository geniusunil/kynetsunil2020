	...
	<script>
		...
		jQuery(document.body).on('click', '#save_customer', function(e)
		{
			...
			jQuery.ajax(
			{
				...
				data:{'id': staff, 'email': email, 'title': subject, 'mess': message, 'file': filename, 'f_name': s_name, 'e_date': dates, 'hid': hh, 'attachment': attachmnt, 'attachment_pdf': attach_pdf, 'attachment_doc': attach_doc, 'pageno':pageno},
