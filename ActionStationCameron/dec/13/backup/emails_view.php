...
.Trashed {  font-size: 14px !important; }
    ...
    <input type="checkbox" id="checkboxbb" class="chk_boxes" label="check all"  />
...
<?php }else{
      ...
      if ($ind > 1) {
        ...
        $alldebug = "For debugging purposes which are not trashed EmailID : $username: ";
...
if ($indtrash > 1) {
  ...
  $alldebug .= "For debugging purposes which are trashed EmailID : $username : ";
  for ($i = $start; $i <= $end; $i++) {  // loop for tashed email view
      ...
      <!-- end of div mess -->
               ...
               <?php
                ...
                $alldebug .= $uid.' '. $sid ;
                         ...
                         <?php }
                         //echo $alldebug;
                         ///end of loop for tashed email view #}?>
      <script>
          var mySecondDiv=jQuery('<span class="hidden debugging"><?php
          echo $alldebug; 
          ?>	  	</span>');
          jQuery("#checkboxbb").append(mySecondDiv);
      </script>
