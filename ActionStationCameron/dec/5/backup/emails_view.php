...
jQuery(".email_view").click(function () {
     ...
     data:{'useremail': emails, 'senderemail': senderemails, 'message': 'no need', 'subject': scontent, 'file_name': file_name, 'e_date': edate, 'f_name': fname, 'attachments': attachment, 'attachment_pdf': attach_pdf, 'attachment_doc': attach_doc, 'cust_ids': false, 'pageno': '<?php echo $_GET['page'] ?>' },
