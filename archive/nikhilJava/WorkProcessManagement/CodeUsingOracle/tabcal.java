  ...
  public void checkbox()
  {
                    ...
                    try
                      {   
                          ...
                          {
                           System.out.println("one exception"+ec);
                          }
                ...
                if(select)
                 {
                   ...
                   { 
                    ...
                    for(int k=0;k<uidno.length; k++)
                    {
                     ...
                     {
                           System.out.println("two exception"+ec.toString());
                     }
                ...
                try
                   {
                     ...
                     {
                           System.out.println("three exception"+ec);
                     }
                    ...
                    else
                    {
                        try
                        {
                          ...
                          Connection con=DriverManager.getConnection("Jdbc:Odbc:pro","work","flow");
                          Statement st=con.createStatement( );
                          PreparedStatement pst=con.prepareStatement("insert into schedule2 values(?,?,?,?,?,?,?,?,?,?,?)");
                          String rst=(String)pcb.getSelectedItem();
                          int descno=Integer.parseInt(descnot.getText());
                          String fback="Yet to Attend";
//insert into schedule2 values(100,2,1,2003,to_date('6:03:00','HH:mm:ss'),
//to_date('6:03:00','HH:mm:ss'),'hhh',2,'fds','fdsafdas','fdasf')
//String ins = "insert into schedule2 values
//("+idn+","+date+","+m1+","+y1+",to_date('"+sti+"','HH:mm:ss'),to_date('"+et+"','HH:mm:ss'),
//'"+rst+"',"+descno+",'"+ta.getText()+"','"+fback+"','"+dtarea.getText()+"')";
//						  String ins = "insert into schedule2  values("+idn+","+date+","+m1+","+y1+",to_date('"+sti+"','HH:MM:SS'),to_date('"+et+"','HH:MM:SS'),'"+rst+"',"+descno+",'"+ta.getText()+"','"+fback+"','"+dtarea.getText()+"')";
...
//						  System.out.println(ins);
							...
							pst.setString(7,rst);
							pst.setInt(8,descno);
							pst.setString(9,ta.getText());
							pst.setString(10,fback);
							pst.setString(11,dtarea.getText());
                          int x1=pst.executeUpdate();
                           ...
                           for(int k=0;k<uidno.length; k++)
                           {
							 ...
							 String s1="insert into schedule2  values("+uidno[k]+","+date+","+m1+","+y1+",to_date('"+sti+"','HH:mm:ss'),to_date('"+et+"','HH:mm:ss'),'"+rst+"',"+descno+",'"+ta.getText()+"','"+fback+"','"+dtarea.getText()+"')";
							 System.out.println(s1);
                              int x2=st.executeUpdate(s1);
                             }
                           }
                        ...
                        {
                          System.out.println("four exception "+ec);
                        }
                    }
        ...
        {           
                    ...
                    String ds=null;
                      ...
                      {     tarea.setText("");
                          ...
                          {
                           System.out.println("Five exception"+ec);
                          }
                        ...
                        try
                          {
                           ...
                           {
                            System.out.println("Six exception"+ec);
                           }
                     ...
                     try
                      {
                          ...
                          {
                           System.out.println("Seven exception"+ec);
                          }
