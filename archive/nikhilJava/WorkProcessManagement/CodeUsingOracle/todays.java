  ...
  public class todays extends JFrame implements ActionListener
  {
        ...
        public void display()
        {
               ...
               td.setText(""+d+"/ "+m+"/ "+y+"");
                  try
                  {
                    ...
                    System.out.println("select shour,smin,ehour,emin,fback,descr from schedule2  where idno="+id+" and dd="+d+" and mm="+m+" and yy="+y+"");
                    rs=st.executeQuery("select stime,etime,fback,descr from schedule2  where idno="+id+" and dd="+d+" and mm="+m+" and yy="+y+"");
         ...
         public void method()
         {
            ...
            {
                  System.out.println("Error in the method "+ee5.toString());
            }
       }//end of void method.
     ...
     public void actionPerformed(ActionEvent ae)
     {
            ...
            if(o==b1)
            {
              ...
              {
                   System.out.println("eeeer in the todays"+eee);
              }
            }
