...
if not "%JAVA_HOME%" == "c:\j2sdk1.4" goto gotJavaHome
...
set _SECSTARTJAVA=start "Secure Tomcat 3.2" "c:\j2sdk1.4\bin\java"
set _STARTJAVA=start "Tomcat 3.2" "c:\j2sdk1.4\bin\java"
set _RUNJAVA="c:\j2sdk1.4\bin\java"
goto setClasspath

:noTitle
set _SECSTARTJAVA=start "c:\j2sdk1.4\bin\java"
set _STARTJAVA=start "c:\j2sdk1.4\bin\java"
set _RUNJAVA="c:\j2sdk1.4\bin\java"
...
set CP=%CP%;%CLASSPATH%
:noClasspath
if not exist "c:\j2sdk1.4\lib\tools.jar" goto installClasspath
set CP=%CP%;c:\j2sdk1.4\lib\tools.jar
:installClasspath
echo.
