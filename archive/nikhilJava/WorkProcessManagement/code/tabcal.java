        ...
        {           
                    ...
                    String ds=null;
                      ...
                      {     tarea.setText("");
                            ...
                            rs=st.executeQuery("select stime,etime,desc from schedule2  where idno="+idn+" and dd="+date+" and mm="+m1+" and yy="+y1);
                            while(rs.next())
                            {
                     ...
                     try
                      {
                           ...
                           Connection con=DriverManager.getConnection("Jdbc:Odbc:pro");
                           Statement st=con.createStatement();
                           rs=st.executeQuery("select stime,etime,desc from schedule2  where idno="+id4+" and dd="+date+" and mm="+m1+" and yy="+y1);
