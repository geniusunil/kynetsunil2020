<?php
							file_put_contents(ABSPATH."debug2.txt","test passed1".PHP_EOL,FILE_APPEND);

							file_put_contents("listingwithmap.txt","hello1",FILE_APPEND);
					$type = 'listing';
					$term_id = '';
					$taxName = '';
					$termID = '';
					...
					file_put_contents("debug.txt","test passed5".PHP_EOL,FILE_APPEND);

										file_put_contents("listingwithmap.txt","hello5",FILE_APPEND);
					...
					if(($found >= 1)){
						...
						$foundtext = esc_html__('Results', 'listingpro');
								...
								file_put_contents("debug.txt","test passed6".PHP_EOL,FILE_APPEND);

										file_put_contents("listingwithmap.txt","hello6",FILE_APPEND);
										file_put_contents("listingwithmap.txt","hello6 args".print_r($args,true),FILE_APPEND);
								...
								if(($found >= 1)){
									...
									$foundtext = esc_html__('Results', 'listingpro');
										...
										file_put_contents("debug.txt","test passed2".PHP_EOL,FILE_APPEND);

										file_put_contents("listingwithmap.txt","hello2",FILE_APPEND);
										$my_query = new WP_Query($args);
					...
					if($tax_query != false) {
						...
						file_put_contents("debug.txt","test passed3".PHP_EOL,FILE_APPEND);

										file_put_contents("listingwithmap.txt","hello3\n".print_r($args_n,true),FILE_APPEND);
					} else {
						$args_n=array(
							'post_type' => $type,
							'post_status' => 'publish',
						...
						file_put_contents("debug.txt","test passed4".PHP_EOL,FILE_APPEND);

										file_put_contents("listingwithmap.txt","hello4",FILE_APPEND);
					}
