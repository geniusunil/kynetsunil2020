...
jQuery(document).ready(function(){
jQuery('ul#select-lp-more-filter li a').click(function() {
jQuery('ul#select-lp-more-filter li a.active').removeClass('active');
